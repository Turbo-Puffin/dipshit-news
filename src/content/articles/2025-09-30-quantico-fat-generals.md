---
headline: "President tells eight hundred generals the homeland is a 'training ground'; the Defense Secretary, alongside, complains about beards and weight."
deck: "Quantico amphitheater. Hours of remarks. The line that traveled was 'fat generals.' The other line was 'enemy from within.'"
date: 2025-09-30
author: carla-boone
score: 82
category: staffing
tags: ["quantico", "fat-generals", "enemy-within"]
sourceUrl: "https://www.washingtonpost.com/politics/2025/09/30/trump-quantico-military-generals/"
sourcePublisher: "Washington Post"
readTime: "3 min read"
blurb: "Eight hundred generals in the room. Beards, weight, and the 'enemy from within.' Hon."
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The remarks are on the official transcript."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The Secretary criticized 'fat generals' from a podium directly in front of them."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The remarks were prepared. The 'enemy from within' framing was unscripted."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. Multiple retired flag officers went on Sunday shows."
  - label: "Public spectacle"
    score: 16
    cap: 20
    note: "Carried live by every defense outlet. Multiple international wires picked up."
---
