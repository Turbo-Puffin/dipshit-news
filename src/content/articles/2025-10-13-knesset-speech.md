---
headline: "President addresses the Knesset; declares 'the war is over' on the day phase one of the deal begins."
deck: "Phase one is twenty hostages out and a withdrawal line. Phase two does not exist on paper yet."
date: 2025-10-13
author: frank-dalton
score: 70
category: foreign
tags: ["knesset", "gaza", "phase-one"]
sourceUrl: "https://time.com/7325314/trump-israel-knesset-speech-hamas-cease-fire-gaza-war-hostages/"
...
rubric:
  - label: "Factual basis"
    score: 12
    cap: 25
    note: "The 20-point plan exists. Phase two does not."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The Knesset gave him standing ovations. He took it as ratification."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The diplomatic side stayed disciplined; the President went off-script."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "Flew to Sharm el-Sheikh the same day to actually sign the document."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Live coverage in nine languages."
---
