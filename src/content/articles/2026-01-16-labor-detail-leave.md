---
headline: "Labor Secretary's security detail officer placed on leave amid romantic-relationship investigation."
deck: "Internal complaint alleges the secretary pursued a relationship with a subordinate on the protective detail."
date: 2026-01-16
author: frank-dalton
score: 65
category: staffing
tags: ["labor", "chavez-deremer", "ig-investigation"]
...
rubric:
  - label: "Factual basis"
    score: 14
    cap: 25
    note: "The leave is documented; the complaint exists; the resignation comes later."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The leave was administrative, not voluntary."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The IG opened a formal investigation."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The Secretary did not address it publicly until April."
  - label: "Public spectacle"
    score: 8
    cap: 20
    note: "Trade press; broke into the Sunday shows after April resignation."
---
