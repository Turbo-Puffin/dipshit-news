---
headline: "President's emergency motion: please let us keep building the ballroom while we figure out the war."
deck: "An emergency appeal filed Saturday on a $400 million ballroom that, the lawyers wrote, has a national-security bunker underneath."
date: 2026-04-04
author: frank-dalton
score: 70
category: orders
tags: ["ballroom", "emergency-motion", "bunker"]
sourceUrl: "https://www.washingtonpost.com/politics/2026/04/04/trump-ballroom-appeal-emergency/"
sourcePublisher: "The Washington Post"
readTime: "3 min read"
blurb: "On a war Saturday, the urgent legal filing was the East Wing ballroom appeal. The argument: there is a bunker."
featured: false
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The motion is a public filing. The bunker reference is on the record."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "Filed during the active Iran war."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "Counsel did not separate the security argument from the ballroom argument."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The motion was the recovery attempt."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "Carried by the Saturday wires."
---
