---
headline: "Trade adviser tells Fox News data center builders may have to absorb their own electricity costs."
deck: "Peter Navarro on television, on Sunday, working a problem the rate-setting authorities thought belonged to them."
date: 2026-02-15
author: carla-boone
score: 65
category: economy
tags: ["navarro", "data-centers", "electricity"]
sourceUrl: "https://www.foxnews.com/politics/trumps-12b-rare-earth-plan-targets-china-experts-warn-us-one-crisis-away"
...
rubric:
  - label: "Factual basis"
    score: 13
    cap: 25
    note: "The remarks are on the network's transcript. The legal authority is on a separate page."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "Sunday-show floats are how this White House does policy now."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "No utility commissioner asked the trade adviser for input."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The position was repeated on cable two days later."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "Energy press picked it up. The Sunday papers passed."
---
