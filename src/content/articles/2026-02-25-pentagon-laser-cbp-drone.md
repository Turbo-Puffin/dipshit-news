---
headline: "The Pentagon shoots down a Border Patrol drone with a laser near Fort Hancock, Texas."
deck: "The drone was operating in restricted military airspace. The agency that flew it had not coordinated with the agency that watches it."
date: 2026-02-25
author: frank-dalton
score: 77
category: staffing
tags: ["pentagon", "cbp", "laser"]
sourceUrl: "https://www.cbsnews.com/news/pentagon-shoots-down-customs-and-border-protection-drone-texas/"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "FAA, DOD, and CBP all confirmed the engagement."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "Second time in two weeks the new laser was used over Texas soil."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "FAA closed the airspace after the engagement, not before."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "Joint statement, calmly worded."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Lawmakers from both parties asked for briefings."
---
