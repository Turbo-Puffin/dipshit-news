---
headline: "Administration asks the appeals court to let the President fire a Federal Reserve governor before the next rate meeting."
deck: "A district judge had blocked the firing. The Fed meets in five days. The case is racing the calendar."
date: 2025-09-12
author: carla-boone
score: 73
category: orders
tags: ["lisa-cook", "federal-reserve", "appeals-court"]
sourceUrl: "https://www.cbsnews.com/news/trump-court-fire-federal-reserve-lisa-cook-interest-rate-meeting-fomc/"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The filings, the district ruling, and the Fed calendar are public."
  - label: "Self-awareness"
    score: 7
    cap: 20
    note: "The administration's brief acknowledges the rate meeting timing."
  - label: "Staff containment"
    score: 10
    cap: 20
    note: "DOJ filed under deadline pressure."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "None offered. The legal theory is the same one rejected at the district level."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Fed independence has been Bloomberg-headline material for two weeks."
---
