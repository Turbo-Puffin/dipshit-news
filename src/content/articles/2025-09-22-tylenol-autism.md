---
headline: "President announces 'taking Tylenol is not good' as the federal position on autism; the medical and scientific community disagrees on the record."
deck: "Roosevelt Room press conference. The HHS Secretary stood next to him. The FDA was directed to draft a label change."
date: 2025-09-22
author: frank-dalton
score: 84
category: health
tags: ["tylenol", "autism", "fda-label"]
sourceUrl: "https://www.cnn.com/2025/09/22/health/trump-autism-announcement-cause-tylenol"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 5
    cap: 25
    note: "The scientific consensus does not support a causal link."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The President said communities without Tylenol have 'no autism.'"
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The HHS Secretary was alongside. Career FDA staff pushed back internally."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The Federal Register notice was filed the same week."
  - label: "Public spectacle"
    score: 16
    cap: 20
    note: "Front page of every health section. Kenvue's stock dropped."
---
