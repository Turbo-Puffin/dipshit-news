---
headline: "King Charles addresses a joint meeting of Congress and presents the President with a submarine bell."
deck: "The state dinner that night was the first white-tie event at the White House since George W. Bush hosted Queen Elizabeth in 2007."
date: 2026-04-28
author: frank-dalton
score: 73
category: foreign
tags: ["state-dinner", "uk", "white-tie"]
sourceUrl: "https://www.cbsnews.com/live-updates/king-charles-trump-address-congress-white-house/"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The joint session, the dinner, the gift exchange are all on the record."
  - label: "Self-awareness"
    score: 9
    cap: 20
    note: "The President's toast emphasized the alliance; he stayed on script."
  - label: "Staff containment"
    score: 13
    cap: 20
    note: "Protocol office ran a clean event."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "Not needed; the night was, by current-era standards, smooth."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "International front pages. The submarine bell got its own headline."
---
