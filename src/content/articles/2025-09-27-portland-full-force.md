---
headline: "President directs the defense secretary to use 'full force' to protect Portland; Portland's mayor says the right number of troops is zero."
deck: "Truth Social post on Saturday afternoon. Portland is not, in fact, war-ravaged. The mayor's statement was on the wires by sundown."
date: 2025-09-27
author: carla-boone
score: 78
category: tweets
tags: ["portland", "national-guard", "full-force"]
sourceUrl: "https://www.nbcnews.com/politics/trump-administration/trump-portland-troops-hegseth-ice-defense-secretary-rcna234082"
...
rubric:
  - label: "Factual basis"
    score: 7
    cap: 25
    note: "Portland's homicide rate is at a multi-year low. ICE protests are not a 'siege.'"
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The post was capital-letter 'War ravaged.'"
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "Hegseth issued the deployment memo by Sunday."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The order was challenged in court within a week."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "The Oregon governor and the Portland mayor both went on Sunday shows."
---
