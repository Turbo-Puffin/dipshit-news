---
headline: "Thanksgiving comes and goes. Ukraine has not signed. The President says the deadline was always 'aspirational.'"
deck: "Monday's deadline became Friday's aspiration. The 28 points are now 19. The negotiations continue."
date: 2025-11-27
author: carla-boone
score: 67
category: foreign
tags: ["ukraine", "thanksgiving", "deadline"]
sourceUrl: "https://abcnews.com/US/putin-zelenskyy-respond-trumps-peace-plan/story?id=127758454"
...
rubric:
  - label: "Factual basis"
    score: 11
    cap: 25
    note: "The Witkoff-Dmitriev draft was reduced to 19 points after Geneva talks; Thanksgiving deadline passed without a Ukrainian signature."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "He spent Thursday at his golf course; the deadline was American."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "Witkoff softened the language; Rubio characterized the new draft as 'progress.'"
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "The reframe from 'deadline' to 'aspiration' was orderly, if late."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "European outlets carried the climbdown."
---
