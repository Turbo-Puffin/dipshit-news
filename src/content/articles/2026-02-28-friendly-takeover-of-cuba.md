---
headline: "President floats a 'friendly takeover of Cuba' on the way to Marine One."
deck: "He told reporters Cuba was talking with the United States. Cuba said it was not."
date: 2026-02-28
author: frank-dalton
score: 71
category: foreign
tags: ["cuba", "marine-one", "takeover"]
sourceUrl: "https://www.aljazeera.com/news/2026/2/27/trump-suggests-a-friendly-takeover-of-cuba-amid-us-fuel-blockade"
...
rubric:
  - label: "Factual basis"
    score: 8
    cap: 25
    note: "Drop Site News reported there were no high-level negotiations. Miami Herald reported the U.S. contact was Castro's grandson, not a senior official."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "Said while walking to the helicopter."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "Rubio is leading the file. Rubio did not, on the record, confirm the takeover framing."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The remark was repeated in a podcast appearance the following week."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Carried in every Spanish-language outlet by Friday night."
---
