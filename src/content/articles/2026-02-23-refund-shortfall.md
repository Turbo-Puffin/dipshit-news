---
headline: "Average tax refunds rise $346, well below the President's promised $1,000."
deck: "The administration's January projection was a $1,000-or-more bump from the One Big Beautiful Bill Act."
date: 2026-02-23
author: vincent-crowe
score: 70
category: economy
tags: ["taxes", "obbba", "refunds"]
sourceUrl: "https://thehill.com/business/5833904-average-2026-tax-refunds-trump-administration-prediction/"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "The IRS filing-season statistics are public. The administration's projection was on the record."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The administration is celebrating the eleven-percent figure."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "Treasury issued a release framing the increase as a victory."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered for the gap between the projection and the result."
  - label: "Public spectacle"
    score: 8
    cap: 20
    note: "Buried under the SOTU coverage."
---
