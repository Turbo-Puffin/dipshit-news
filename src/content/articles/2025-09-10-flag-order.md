---
headline: "President orders all flags to half-staff for a slain conservative activist; he did not issue a similar order for a slain state legislator three months earlier."
deck: "The proclamation came hours after the Utah shooting. A Minnesota state lawmaker assassinated in June received no equivalent order."
date: 2025-09-10
author: frank-dalton
score: 75
category: orders
tags: ["charlie-kirk", "half-staff", "selective-honor"]
sourceUrl: "https://newrepublic.com/post/200317/trump-flags-half-mast-charlie-kirk-melissa-hortman"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The proclamation is on file. The Hortman omission is on the record."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "No mention of the prior assassination."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "The order moved through normal proclamation channels."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The order ran four days."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "State governors followed suit. Several governors had ordered flags down for Hortman in June."
---
