---
headline: "Treasury Secretary visits a House committee; the words 'sharp exchanges' do most of the work."
deck: "Bessent testified before House Financial Services. The official record describes the tone of the room as elevated."
date: 2026-02-04
author: frank-dalton
score: 62
category: economy
tags: ["bessent", "hearings", "tone"]
sourceUrl: "https://www.cnbc.com/2026/02/03/feds-stephen-miran-resigns-from-white-house-post.html"
sourcePublisher: "CNBC"
readTime: "2 min read"
blurb: "The Treasury Secretary testified. The room got loud. The Council of Economic Advisers chair quit the same week."
rubric:
  - label: "Factual basis"
    score: 14
    cap: 25
    note: "Bessent testified. Miran's resignation hit the same news cycle."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The administration's own economists are, on the public record, dissenting."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The CEA chair stepped down to keep his Fed seat. Nobody framed that as a vote of confidence."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The hearing went the duration."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "Carried on financial wires. Skipped on the broadcast feeds."
---
