---
headline: "Kennedy Center board votes to rename the building 'The Donald J. Trump and John F. Kennedy Memorial Center for the Performing Arts.'"
deck: "The federal statute establishing the Center as a memorial to President Kennedy was passed in 1964. The board's authority to rename it without Congress is, according to several legal scholars and one Kennedy family member, doubtful."
date: 2025-12-18
author: carla-boone
score: 78
category: public
tags: ["kennedy-center", "rename", "memorial"]
sourceUrl: "https://www.washingtonpost.com/entertainment/2025/12/18/kennedy-center-renamed-trump/"
...
photo: ../../assets/articles/2025-12-18-kennedy-center-rename.jpg
photoAlt: "Exterior of the John F. Kennedy Center for the Performing Arts in Washington, D.C."
photoCaption: "Photo: Carol M. Highsmith, Library of Congress, via Wikimedia Commons. Public domain."
rubric:
  - label: "Factual basis"
    score: 12
    cap: 25
    note: "The board's vote and the statute are both on the record."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The renaming is the first time a national building has been named for a sitting president."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The board, as packed earlier this year, voted as expected."
  ...
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Performers cancelled the next morning. The Kennedys put out a statement."
---
