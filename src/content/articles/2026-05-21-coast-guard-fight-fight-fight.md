---
headline: "The President Told the Coast Guard to Fight, Fight, Fight."
deck: "The Coast Guard mostly rescues people from boats and stops cocaine on the way in. It does not, generally, fight."
date: 2026-05-21
author: carla-boone
score: 60
category: public
tags: ["coast-guard", "trump", "commencement", "new-london", "military"]
sourceUrl: "https://www.washingtonpost.com/politics/2026/05/20/trump-tells-coast-guard-grads-help-lead-national-resurgence/"
...
rubric:
  - label: "Factual basis"
    score: 24
    cap: 25
    note: "The Washington Post covered the address with direct quotes. PBS and Connecticut outlets also ran the speech."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The President delivered his standard rally rhetoric, fight-fight-fight, win-win-win, golden age, at a service-academy commissioning whose service does search and rescue."
  - label: "Staff containment"
    score: 10
    cap: 20
    note: "The speech was prepared. No cleanup attempted. The rhetoric is house style."
  - label: "Recovery attempt"
    score: 14
    cap: 15
    note: "No walk-back contemplated. This is the brand."
  - label: "Public spectacle"
    score: 10
    cap: 20
    note: "WaPo, PBS, and the Connecticut outlets carried it. It competed for oxygen with the ballroom-bunker tour."
---
