---
headline: "President meets congressional leaders the day before the shutdown deadline; the Vice President says afterward that a shutdown is likely."
deck: "Roosevelt Room. Both leaders. The Vice President's prediction was made walking out, on camera, in the West Wing driveway."
date: 2025-09-29
author: vincent-crowe
score: 68
category: staffing
tags: ["shutdown", "leadership-meeting", "vice-president"]
sourceUrl: "https://www.nbcnews.com/politics/politics-news/live-blog/trump-netanyahu-gaza-government-shutdown-portland-guard-live-updates-rcna234154"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The meeting, the participants, and the VP's remarks are documented."
  - label: "Self-awareness"
    score: 8
    cap: 20
    note: "The President said afterward that 'we will see' if there is a shutdown."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "The Speaker and Minority Leader were both present."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "A second meeting was tentatively scheduled."
  - label: "Public spectacle"
    score: 10
    cap: 20
    note: "Carried on every cable network through the afternoon."
---
