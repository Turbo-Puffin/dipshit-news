---
headline: "President says Republicans should 'nationalize' elections during a podcast appearance."
deck: "The Constitution says elections belong to the states. The remark was made on a former deputy FBI director's podcast."
date: 2026-02-02
author: vincent-crowe
score: 78
category: public
tags: ["elections", "constitution", "podcast"]
sourceUrl: "https://www.washingtonpost.com/politics/2026/02/02/trump-elections-nationalize-fraud/"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The audio is public. The constitutional clause is not."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The remark was made on a former deputy FBI director's podcast."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The White House released a statement pivoting to the SAVE Act."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered by the principal. The Senate Republican leader publicly disagreed."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Picked up by every wire on a Monday."
---
