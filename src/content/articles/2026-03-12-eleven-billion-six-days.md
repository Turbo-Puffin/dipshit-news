---
headline: "The Pentagon tells Congress the first six days of the Iran war cost $11.3 billion."
deck: "The next morning, the Press Secretary said the war was 'achieving objectives faster than anticipated.'"
date: 2026-03-12
author: carla-boone
score: 72
category: economy
tags: ["iran-war", "cost", "pentagon-briefing"]
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "Multiple senators from both parties confirmed the figure on the way out of the briefing."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The figure does not include munitions replacement, which a senator said would push the real number higher."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "The Press Secretary, the next morning, did not address the figure at the briefing."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The administration framed the cost as a measure of intensity, not waste."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "Lead of the politics section in NBC, NPR, and CNN by Thursday afternoon."
---
