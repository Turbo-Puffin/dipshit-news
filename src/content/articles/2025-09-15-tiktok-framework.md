---
headline: "Treasury Secretary announces a 'framework' for a TikTok deal; China has not announced one."
deck: "From Madrid: 'Yes, we have a framework.' From Beijing: silence. The deadline is in four days."
date: 2025-09-15
author: carla-boone
score: 56
category: economy
tags: ["tiktok", "framework", "madrid"]
sourceUrl: "https://www.cnn.com/2025/09/15/tech/trump-tiktok-china-deal"
sourcePublisher: "CNN"
readTime: "2 min read"
...
rubric:
  - label: "Factual basis"
    score: 13
    cap: 25
    note: "Bessent's framework remarks are on the record. The Chinese position was not yet confirmed."
  - label: "Self-awareness"
    score: 8
    cap: 20
    note: "The framework was described, but the parties on both sides were not named."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "Treasury was the messenger. The lead negotiator was the President."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "The President said he would speak with Xi Friday."
  - label: "Public spectacle"
    score: 8
    cap: 20
    note: "Carried by every business wire. Tech stocks barely moved."
---
