---
headline: "President demands an investigation of 'triple sabotage' at the UN; the escalator stopped because his videographer triggered the safety mechanism."
deck: "Stopped escalator. Dead teleprompter. Audio routing through the interpreter feed. The UN explained each in turn."
date: 2025-09-23
author: vincent-crowe
score: 78
category: foreign
tags: ["united-nations", "escalator", "sabotage"]
sourceUrl: "https://www.washingtonpost.com/politics/2025/09/24/trump-video-escalator-teleprompter-united-nations/"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The UN's explanations were detailed, technical, and on the record."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The President's own staff was responsible for two of three malfunctions."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The Truth Social post called for arrests. The press shop did not modulate."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The investigation demand was repeated."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Front page coverage in eight time zones."
---
