---
headline: "President announces a Budapest summit with Putin after a two-hour phone call; the Ukrainian president learns about it on TV."
deck: "The phone call was at the Kremlin's request. The summit was announced before the call to Kyiv was placed."
date: 2025-10-16
author: frank-dalton
score: 75
category: foreign
tags: ["putin", "hungary", "summit"]
sourceUrl: "https://www.cnbc.com/2025/10/16/trump-putin-russia-ukraine.html"
...
rubric:
  - label: "Factual basis"
    score: 12
    cap: 25
    note: "The call happened. The Budapest announcement is on the record. The summit was canceled six days later."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "Announced the day before the Ukrainian president was due in the Oval."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The State Department was reading the wire copy along with everybody else."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "By Oct 22 the summit was off."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Lead foreign-policy story across the wires."
---
