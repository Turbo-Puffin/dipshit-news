---
headline: "Pentagon names the Caribbean operation 'Southern Spear'; the operation is sinking fishing boats."
deck: "Twenty-two strikes since September. Eighty-seven dead, by the Pentagon's own count. No evidence has been published."
date: 2025-11-13
author: frank-dalton
score: 86
category: foreign
tags: ["venezuela", "operation-southern-spear", "boat-strikes"]
sourceUrl: "https://www.npr.org/2025/11/12/nx-s1-5604895/trump-venezuela-drug-boat-strikes"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 8
    cap: 25
    note: "The Pentagon has not produced evidence the targeted vessels were drug carriers in any of the publicly cited strikes."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The Defense Secretary held a televised announcement to brand the operation."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "Hegseth's name was on the launch. The first strike's no-survivors order is reported separately."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The strikes continued."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Caribbean, Latin American, and European outlets ran the announcement."
---
