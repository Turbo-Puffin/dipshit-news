---
headline: "President signs an executive order designating fentanyl and its precursor chemicals as 'weapons of mass destruction,' a category previously reserved for nuclear, biological, and chemical weapons."
deck: "The signing was in the Oval Office. The order directs the Defense Department to consider law-enforcement support."
date: 2025-12-15
author: carla-boone
score: 68
category: orders
tags: ["fentanyl", "wmd", "designation"]
sourceUrl: "https://www.washingtonpost.com/health/2025/12/16/trump-fentanyl-weapon-mass-destruction/"
...
rubric:
  - label: "Factual basis"
    score: 9
    cap: 25
    note: "The category, in international and domestic law, has a specific definition."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The designation is a category leap."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The Pentagon and DOJ will brief the operational implications."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The fact sheet anchors the designation to overdose deaths."
  - label: "Public spectacle"
    score: 10
    cap: 20
    note: "Front of every legal and public-health desk."
---
