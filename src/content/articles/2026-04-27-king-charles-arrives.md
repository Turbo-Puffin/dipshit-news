---
headline: "King Charles III arrives for a four-day state visit, two days after the President was rushed off a Hilton dance floor."
deck: "The greeting on the South Portico. The new beehive on the South Lawn. The address to Congress is on Tuesday."
date: 2026-04-27
author: carla-boone
score: 70
category: foreign
tags: ["state-visit", "uk", "king-charles"]
sourceUrl: "https://www.cnn.com/2026/04/27/us/live-news/king-charles-queen-camilla-us-visit"
sourcePublisher: "CNN"
readTime: "2 min read"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The arrival, the tea, the South Lawn tour are all on the public record."
  - label: "Self-awareness"
    score: 7
    cap: 20
    note: "The choreography proceeded as planned, with no acknowledgment of the Saturday-night incident."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "The protocol was tight; the photographs were standard."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "Not needed; the visit was, on its terms, well-staged."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "Carried on the international wires; the beehive made the photo set."
---
