---
headline: "Defense Secretary invites a pastor who has argued women should not vote to lead the Pentagon prayer service."
deck: "Doug Wilson preached fifteen minutes in the Pentagon auditorium. The Secretary said he was running late and missed it."
date: 2026-02-17
author: vincent-crowe
score: 80
category: staffing
tags: ["pentagon", "wilson", "prayer-service"]
sourceUrl: "https://www.washingtonpost.com/politics/2026/02/18/doug-wilson-pentagon-hegseth-christian-nationalist/"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "The sermon was on the Pentagon's internal television feed. Wilson's prior writings are publicly available."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The Secretary is a member of one of Wilson's churches in Tennessee."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The Pentagon defended the invitation in a written statement."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "The Secretary said he had been running from another meeting and missed the sermon."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Reported in every paper that covers the Department of Defense."
---
