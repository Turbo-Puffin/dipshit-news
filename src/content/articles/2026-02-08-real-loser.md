---
headline: "President calls a competing Olympic skier a 'real loser' on social media."
deck: "The skier had said representing the United States right now brought up 'mixed emotions.'"
date: 2026-02-08
author: vincent-crowe
score: 72
category: tweets
tags: ["olympics", "hess", "truth-social"]
sourceUrl: "https://www.cnn.com/2026/02/08/politics/hunter-hess-trump-olympics-skier"
sourcePublisher: "CNN"
readTime: "2 min read"
...
rubric:
  - label: "Factual basis"
    score: 21
    cap: 25
    note: "The Truth Social post is on the public account. Hess's quotes are on the press conference transcript."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The post was issued from the residence on a Sunday morning."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "No public correction from the communications staff."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "Hess responded with 'I love my country.' The post remained up."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "The skier flashed an L sign at the bottom of his halfpipe qualifying run."
---
