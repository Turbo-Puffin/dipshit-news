---
headline: "President announces 'most-favored-nation' drug pricing deals with nine pharmaceutical companies; the companies receive a three-year tariff reprieve in return."
deck: "Amgen, Bristol Myers Squibb, Boehringer Ingelheim, Genentech, Gilead, GSK, Merck, Novartis, Sanofi. The deal is described as $150 billion in U.S. investment commitments."
date: 2025-12-19
author: frank-dalton
score: 64
category: economy
tags: ["drug-prices", "most-favored-nation", "pharma-deals"]
sourceUrl: "https://www.cnn.com/2025/12/19/politics/us-drug-prices-trump-nation-deals"
sourcePublisher: "CNN Politics"
readTime: "3 min read"
blurb: "Nine pharma companies, MFN pricing on Medicaid, three-year tariff reprieve. The Repatha price did, in fact, drop. Buddy."
...
rubric:
  - label: "Factual basis"
    score: 14
    cap: 25
    note: "The deal terms are on the white paper. Some of the price drops are real."
  - label: "Self-awareness"
    score: 7
    cap: 20
    note: "The tariff reprieve is the cost of the price cut, not a separate deliverable."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "The pharma CEOs were on stage. The transcripts were on script."
  - label: "Recovery attempt"
    score: 7
    cap: 15
    note: "The Repatha drop, if delivered, is meaningful for cardiac patients."
  - label: "Public spectacle"
    score: 10
    cap: 20
    note: "Front of every health and business desk."
---
