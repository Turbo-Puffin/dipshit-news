---
headline: "The DHS funding lapse becomes the longest shutdown in American history."
deck: "Day 44. Sixty-one thousand TSA officers without paychecks. The Senate Democratic leader and the House Speaker have not been in the same room in two weeks."
date: 2026-03-29
author: vincent-crowe
score: 76
category: economy
tags: ["dhs-shutdown", "longest-shutdown", "tsa"]
sourceUrl: "https://www.nbcnews.com/politics/trump-administration/dhs-funding-lapse-longest-partial-government-shutdown-us-history-rcna265645"
...
rubric:
  - label: "Factual basis"
    score: 21
    cap: 25
    note: "The shutdown's day count and the previous record are on the public record."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The administration's framing has been that the shutdown is the responsibility of the opposition."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "The Speaker and the Senate Democratic Leader have not met in person in two weeks."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The Senate has passed an extension. The House majority has refused to take it up."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Lead of every Sunday wire."
---
