---
headline: "President calls the elected president of Colombia an 'illegal drug leader' on his social network."
deck: "The Sunday post announced the immediate cancellation of all U.S. assistance to Colombia, in writing, in capital letters."
date: 2025-10-19
author: frank-dalton
score: 74
category: foreign
tags: ["colombia", "petro", "name-calling"]
sourceUrl: "https://www.npr.org/2025/10/20/nx-s1-5579661/trump-tariffs-aid-colombia-amid-clash-drugs-petro"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 7
    cap: 25
    note: "The post is in the public record. The aid cutoff was announced before the policy paperwork."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "Colombia is a treaty ally and the largest U.S. partner in counter-narcotics in the hemisphere."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "The State Department was reading along with everybody else."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The announced tariff materialized Monday."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Front page across Latin America."
---
