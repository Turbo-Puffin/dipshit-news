---
headline: "President sets a Thanksgiving deadline for Ukraine to surrender on terms drafted with Russia."
deck: "Ukraine has four days. The Russians have already accepted, in principle, a document they helped write."
date: 2025-11-23
author: vincent-crowe
score: 80
category: foreign
tags: ["ukraine", "deadline", "thanksgiving"]
sourceUrl: "https://www.cnn.com/politics/live-news/trump-ukraine-news-11-22-25"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 12
    cap: 25
    note: "Thanksgiving (Nov 27) was the public deadline; the plan was drafted with Russian input."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "He set the deadline on a holiday weekend; the holiday was American."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "Witkoff and Rubio defended the timeline on the Sunday shows; European allies were furious."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "By Monday the deadline was 'flexible.'"
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "European leaders held an emergency call. Markets opened lower in Frankfurt and London."
---
