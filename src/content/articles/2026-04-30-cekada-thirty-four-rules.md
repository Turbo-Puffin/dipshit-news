---
headline: "Senate confirms a new ATF director who, the same day, signs thirty-four gun-rule changes."
deck: "Bipartisan vote. Seven Democrats. Final action: undoing prior rulemakings before the ink on the swearing-in dries."
date: 2026-04-30
author: carla-boone
score: 74
category: staffing
tags: ["atf", "guns", "rulemaking"]
sourceUrl: "https://www.nbcnews.com/politics/justice-department/justice-department-moves-roll-back-gun-regulations-rcna342825"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "The roll call is recorded; the rulemaking notices are public."
  - label: "Self-awareness"
    score: 8
    cap: 20
    note: "The package was prepared in advance; the timing was the point."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "The Acting Attorney General joined the announcement; the staging was tight."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None needed; this was the recovery from years of unconfirmed leadership."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "Gun-policy press carried it; the bipartisan margin made the wires."
---
