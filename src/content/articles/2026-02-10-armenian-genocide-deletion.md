---
headline: "Vice President's account posts then deletes a recognition of the Armenian Genocide."
deck: "Posted from a wreath-laying in Yerevan. Up briefly. The official excuse was 'sent in error.'"
date: 2026-02-10
author: frank-dalton
score: 76
category: foreign
tags: ["vance", "armenia", "deletion"]
sourceUrl: "https://www.cnn.com/2026/02/10/politics/jd-vance-x-post-armenian-genocide"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The post was screenshotted before deletion. The Vance handwritten note is in the guestbook."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The wreath-laying was scheduled. The post was, allegedly, the surprise."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "The press secretary's reposted version had a more careful caption."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "Office statement: 'sent in error.'"
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Coverage in every Armenian-American outlet within hours, plus Turkish state media."
---
