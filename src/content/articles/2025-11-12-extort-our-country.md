---
headline: "President signs the bill to end his own shutdown and announces the country has been extorted."
deck: "He spent forty days saying the shutdown was good. On day forty-three he signed the deal and called it ransom."
date: 2025-11-12
author: carla-boone
score: 76
category: presser
tags: ["shutdown", "signing", "extortion"]
sourceUrl: "https://www.cnbc.com/2025/11/12/government-shutdown-house-vote-trump.html"
...
rubric:
  - label: "Factual basis"
    score: 8
    cap: 25
    note: "The shutdown was caused by a Senate impasse over ACA subsidies. The administration was the deal's biggest beneficiary in narrative terms."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "Two weeks earlier he had described the shutdown as 'good for us.'"
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "Press secretary held the line on 'extortion' for the cycle."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "He told the country to remember it 'at midterms,' which Tuesday's results suggest the country had already done."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Late-night Oval signing, on camera, with the legible signature."
---
