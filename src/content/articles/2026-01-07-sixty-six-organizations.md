---
headline: "President signs a memo withdrawing the United States from sixty-six international organizations."
deck: "The list includes the climate panel, the conservation union, and a special representative for children in armed conflict."
date: 2026-01-07
author: frank-dalton
score: 80
category: foreign
tags: ["withdrawals", "ipcc", "international-bodies"]
sourceUrl: "https://www.cnn.com/2026/01/07/climate/trump-withdrawal-climate-treaty-international-agreements"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The list of 66 is published. Most of the organizations exist on paper and exist only on paper to the United States now."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "Framed as 'contrary to US interests.' The Children in Armed Conflict office was on the list."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "State Department signed the memo. Career diplomats did not."
  - label: "Recovery attempt"
    score: 3
    cap: 15
    note: "None. The list was the document."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Above the fold in every European capital."
---
