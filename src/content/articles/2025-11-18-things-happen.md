---
headline: "President welcomes the Saudi crown prince and tells the country, on camera, that 'things happen.'"
deck: "ABC's Mary Bruce asked about Khashoggi. The answer was 'things happen.' The Crown Prince did not need to speak."
date: 2025-11-18
author: carla-boone
score: 88
category: foreign
tags: ["saudi-arabia", "khashoggi", "press-room"]
sourceUrl: "https://www.washingtonpost.com/world/2025/11/18/saudi-prince-trump-visit-white-house/"
...
rubric:
  - label: "Factual basis"
    score: 5
    cap: 25
    note: "DNI's 2021 unclassified assessment concluded MBS approved the operation."
  - label: "Self-awareness"
    score: 3
    cap: 20
    note: "He scolded the reporter for the question rather than answering it."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "Press shop did not correct the 'things happen' line."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. He moved on to F-35s."
  - label: "Public spectacle"
    score: 16
    cap: 20
    note: "Front pages on every continent. Khashoggi's family responded publicly."
---
