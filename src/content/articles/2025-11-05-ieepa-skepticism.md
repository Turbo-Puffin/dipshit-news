---
headline: "Supreme Court asks the Solicitor General whether 'regulate' means 'tax anything forever.'"
deck: "Oral argument in Learning Resources v. Trump. The Chief Justice was not persuaded."
date: 2025-11-05
author: vincent-crowe
score: 76
category: orders
tags: ["scotus", "tariffs", "ieepa"]
sourceUrl: "https://www.thompsonhinesmartrade.com/2025/11/trumps-emergency-tariffs-face-scrutiny-and-skepticism-at-the-supreme-court-2/"
...
rubric:
  - label: "Factual basis"
    score: 12
    cap: 25
    note: "IEEPA is a 1977 sanctions statute that has never before been used to set tariffs."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The Solicitor General argued the statute confers unlimited power; he did not flinch when the bench noticed."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "The administration sent its own lawyers to make the argument it asked them to make."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "On the steps after, the President said he would impose 10% across the board no matter what the Court did."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "Live audio. Court-watchers projected a 6-3 loss within the hour."
---
