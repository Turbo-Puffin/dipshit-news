---
headline: "An executive order requires citizenship verification and rewrites mail-ballot rules."
deck: "Election lawyers, including ones who have voted for the President, said the order is unconstitutional on its face."
date: 2026-03-31
author: frank-dalton
score: 78
category: orders
tags: ["voting", "executive-order", "citizenship-verification"]
sourceUrl: "https://www.npr.org/2026/03/31/nx-s1-5508948/trump-voter-list-mail-ballots-executive-order"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 20
    cap: 25
    note: "The order is on the Federal Register. The reactions from election-law experts are on the public record."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The same President signed a similar order in March 2025. That order was enjoined within thirty days."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "DHS and the Postmaster General both said they would 'review' the order."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "Six lawsuits were filed by Tuesday evening."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Front of every Wednesday paper."
---
