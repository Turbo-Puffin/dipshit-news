---
headline: "Cabinet meeting runs three hours and sixteen minutes; opens with a forty-five minute monologue."
deck: "The President speaks at length about windmills, redecorating, furniture tariffs, and a 1,500-percent reduction in drug prices that does not exist."
date: 2025-08-26
author: vincent-crowe
score: 78
category: presser
tags: ["cabinet-meeting", "marathon", "monologue"]
sourceUrl: "https://www.pbs.org/newshour/politics/watch-live-trump-holds-a-cabinet-meeting"
...
rubric:
  - label: "Factual basis"
    score: 6
    cap: 25
    note: "Prices cannot be reduced by more than 100 percent. The drug companies were named incorrectly."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "Said he had been at work only several months because of redecorating."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "Each cabinet secretary was given the floor. Many seemed prepared. None corrected the math."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The 1,500 percent figure stands."
  - label: "Public spectacle"
    score: 16
    cap: 20
    note: "The full session was carried live on multiple networks."
---
