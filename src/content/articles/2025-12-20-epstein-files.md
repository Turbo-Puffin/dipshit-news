---
headline: "Justice Department releases the court-ordered Epstein file batch with extensive redactions; one image of the President appears, briefly, then is removed from the website."
deck: "The release was on a statutory deadline. The redactions were dense. The single image was the part the press caught."
date: 2025-12-20
author: vincent-crowe
score: 70
category: staffing
tags: ["epstein-files", "redaction", "justice-department"]
sourceUrl: "https://www.cnn.com/politics/live-news/trump-epstein-news-12-20-25"
sourcePublisher: "CNN Politics"
readTime: "3 min read"
blurb: "The DOJ released the files Friday. One image, of the President, appeared on the site briefly. The file is now offline."
...
rubric:
  - label: "Factual basis"
    score: 11
    cap: 25
    note: "The release is on the DOJ portal. The redactions are visible."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "A removed image, after release, is the part the reporters notice."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The release portal was managed by DOJ staff."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "DOJ told reporters the removal was a 'redaction error.'"
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Front of every legal desk over the weekend."
---
