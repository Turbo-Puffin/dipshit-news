---
headline: "President signs an executive order renaming the Department of Defense the Department of War; only Congress can actually rename it."
deck: "The order authorizes the Pentagon to use the secondary title in non-statutory communications. The legal name remains unchanged."
date: 2025-09-05
author: vincent-crowe
score: 76
category: orders
tags: ["department-of-war", "executive-order", "rebranding"]
sourceUrl: "https://www.npr.org/2025/09/04/nx-s1-5529420/trump-department-of-war-department-of-defense"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The text of Executive Order 14347 is on file."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The order itself acknowledges Congress retains the statutory name."
  - label: "Staff containment"
    score: 12
    cap: 20
    note: "OMB and DoD coordinated the implementation."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "None offered. Senators introduced legislation to formalize."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "The Pentagon website redirected to war.gov by Friday afternoon."
---
