---
headline: "President arrives at Windsor for a state visit; calls being the only American president to receive two of them 'maybe the last time, I hope it is, actually.'"
deck: "Marine One on the lawn. Carriages. Pageantry. The toast included an unprompted aside about being the last."
date: 2025-09-16
author: frank-dalton
score: 67
category: foreign
tags: ["state-visit", "windsor", "toast"]
sourceUrl: "https://www.pbs.org/newshour/politics/king-charles-iii-greets-trump-in-windsor-at-start-of-presidents-second-state-visit-to-the-uk"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The toast transcript is on the official record."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The remark was extemporaneous."
  - label: "Staff containment"
    score: 10
    cap: 20
    note: "The state banquet remarks were prepared. The aside was not."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "He called it one of the highest honors of his life."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "The British tabloids ran the line on every front page Wednesday."
---
