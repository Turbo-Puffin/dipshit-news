---
headline: "President delivers the longest State of the Union address in American history."
deck: "One hour, forty-seven minutes, forty seconds. Twenty minutes longer than the previous record. Held by Bill Clinton."
date: 2026-02-24
author: carla-boone
score: 76
category: presser
tags: ["state-of-the-union", "longest", "record"]
sourceUrl: "https://www.npr.org/2026/02/24/nx-s1-5725496/trump-state-union-longest-speech"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 22
    cap: 25
    note: "Carried live, timed by every wire."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "He set his own previous record. He broke it."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "The text was a hundred percent pre-screened. The length was self-administered."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The address ran the full length."
  - label: "Public spectacle"
    score: 16
    cap: 20
    note: "Carried on every broadcast network. The Senate floor stayed seated."
---
