---
headline: "Plan for the new ballroom relies on a 1964 executive order to skip the review board."
deck: "The federal commission that has signed off on additions to the White House since 1910 will, this time, be invited to look at the finished plan."
date: 2025-08-10
author: frank-dalton
score: 73
category: orders
tags: ["ballroom", "review-bypass", "ncpc"]
sourceUrl: "https://www.washingtonpost.com/politics/2025/08/10/trump-ballroom-white-house-oversight-commission-law/"
sourcePublisher: "Washington Post"
readTime: "3 min read"
blurb: "Federal review of additions to the White House has existed since 1910. This time the answer is: maybe later."
rubric:
  - label: "Factual basis"
    score: 11
    cap: 25
    note: "The reporting is concrete. The administration confirms the bypass."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The 1964 executive order being invoked was not designed for ballrooms."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The reasoning was offered by an administration official on the record."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "An NCPC review is described as possibly happening 'later.'"
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Front-page Washington Post."
---
