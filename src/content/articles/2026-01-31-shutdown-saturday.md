---
headline: "Government partially shuts down on Saturday morning over a DHS funding fight."
deck: "Senate Democrats refused the package because it funded ICE without conditions. The protests outside the Capitol drew tens of thousands."
date: 2026-01-31
author: frank-dalton
score: 80
category: economy
tags: ["shutdown", "dhs", "ice-out"]
sourceUrl: "https://www.npr.org/2026/01/31/nx-s1-5694716/partial-government-shutdown"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The shutdown, the DHS-funding cause, and the protests are all on the record."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The administration framed it as the Senate's fault."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "Both chambers cleared a short-term reopen by the following week."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "A short-term continuing resolution. The DHS fight punted two weeks."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Three hundred protests. Cable wall-to-wall."
---
