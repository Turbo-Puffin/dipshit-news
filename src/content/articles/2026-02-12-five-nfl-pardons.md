---
headline: "President pardons five former NFL players for crimes including drug trafficking and perjury."
deck: "One of the five had pleaded guilty to financing a cocaine ring. The pardon czar made the announcement."
date: 2026-02-12
author: carla-boone
score: 69
category: orders
tags: ["pardons", "nfl", "drug-trafficking"]
sourceUrl: "https://www.npr.org/2026/02/13/nx-s1-5713307/trump-nfl-pardons"
sourcePublisher: "NPR"
readTime: "2 min read"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "The pardons are on the public record. The convictions are also on the public record."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The same week the DOJ continued prosecutions of low-level drug offenders elsewhere."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The pardon czar handled the announcement on her own."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None needed. The President considers it a sports gesture."
  - label: "Public spectacle"
    score: 10
    cap: 20
    note: "Sports pages, mostly. Cable picked it up by Friday morning."
---
