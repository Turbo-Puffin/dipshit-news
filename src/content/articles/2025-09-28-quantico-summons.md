---
headline: "Defense Secretary summons every general and admiral at the rank of brigadier and up to a single room in Virginia; the agenda is not announced."
deck: "Eight hundred flag officers. Hours of warning. Travel orders cut without justification on the cable. The President will now attend."
date: 2025-09-28
author: frank-dalton
score: 81
category: staffing
tags: ["quantico", "generals", "summons"]
sourceUrl: "https://fortune.com/2025/09/28/pentagon-generals-admirals-quantico-meeting-trump-pete-hegseth/"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The summons, the headcount, and the absence of an agenda are documented."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The President characterized it as a 'really nice meeting.'"
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "Hegseth's office did not provide an agenda to attendees."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The President added himself to the program by Sunday."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Front pages on every defense outlet. Three former defense secretaries publicly questioned the move."
---
