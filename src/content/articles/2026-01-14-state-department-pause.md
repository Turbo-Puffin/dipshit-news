---
headline: "State Department suspends immigrant visa processing for nationals of seventy-five countries."
deck: "The directive went to consulates by cable. The list of countries was redacted in the public version."
date: 2026-01-14
author: vincent-crowe
score: 75
category: orders
tags: ["state-department", "visas", "consular"]
sourceUrl: "https://en.wikipedia.org/wiki/Timeline_of_the_second_Trump_presidency_(2026_Q1)"
...
rubric:
  - label: "Factual basis"
    score: 14
    cap: 25
    note: "The cable exists. The redacted list does not match the public proclamation list."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "Issued through consular channels rather than by proclamation."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "The Foreign Service implemented; legal challenges followed."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None. The cable stood."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "Trade press; immigration bar; Commonwealth governments."
---
