---
headline: "President orders every federal agency to immediately stop using Anthropic AI technology."
deck: "The dispute was about whether the Pentagon could use the model for mass surveillance and autonomous targeting. The company said no."
date: 2026-02-27
author: carla-boone
score: 82
category: orders
tags: ["anthropic", "ai", "pentagon"]
sourceUrl: "https://www.cbsnews.com/news/trump-anthropic-ai-order-federal-agencies/"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "The Truth Social post is on the public record. The Pentagon designation is on the official letter."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The President's stated reason, in capitals, was 'we don't need it, we don't want it.'"
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "Hegseth issued the supply-chain-risk designation in the same hour."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "DOD was given six months to wind down. Other agencies, immediate."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Lead story on every tech wire and most political ones."
---
