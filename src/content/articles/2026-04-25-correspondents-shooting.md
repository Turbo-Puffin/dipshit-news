---
headline: "Shots fired at the Correspondents' Dinner. The President is evacuated. The shooter is detained at the magnetometer."
deck: "A Secret Service officer in a vest takes a pellet to the chest. Notes recovered from the suspect indicate administration targets."
date: 2026-04-25
author: frank-dalton
score: 89
category: public
tags: ["correspondents-dinner", "shooting", "secret-service"]
sourceUrl: "https://www.washingtonpost.com/politics/2026/04/25/trump-whcd-evacuation-live-updates/"
...
rubric:
  - label: "Factual basis"
    score: 22
    cap: 25
    note: "The DOJ press release and the police narrative are public; pool reporting is consistent."
  - label: "Self-awareness"
    score: 9
    cap: 20
    note: "The President's first remarks praised the agent and were, by his standards, restrained."
  - label: "Staff containment"
    score: 13
    cap: 20
    note: "Secret Service narrative was disclosed in detail; the principals were extracted without incident in the room."
  - label: "Recovery attempt"
    score: 8
    cap: 15
    note: "The dinner was paused; the floor was cleared; the protectees were safe within minutes."
  - label: "Public spectacle"
    score: 17
    cap: 20
    note: "Front page worldwide. Live cameras at the Hilton."
---
