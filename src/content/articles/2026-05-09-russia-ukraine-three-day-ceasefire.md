---
headline: "President announces a three-day Russia-Ukraine ceasefire that conveniently covers Victory Day."
deck: "Both sides agreed, the President says, with a thousand-prisoner swap thrown in. The pause expires Monday."
date: 2026-05-09
author: carla-boone
score: 64
category: foreign
tags: ["russia", "ukraine", "ceasefire"]
sourceUrl: "https://www.opb.org/article/2026/05/09/trump-says-russia-and-ukraine-have-agreed-to-ceasefire/"
...
rubric:
  - label: "Factual basis"
    score: 14
    cap: 25
    note: "Both sides confirmed something. What kind of something is the question."
  - label: "Self-awareness"
    score: 7
    cap: 20
    note: "Called it 'the beginning of the end.' Three days long."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "State and the Russians and the Ukrainians all read from the same page."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "Not required. He's selling it as a win."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Front of every paper. The dateline is May 9. So is Victory Day."
---
