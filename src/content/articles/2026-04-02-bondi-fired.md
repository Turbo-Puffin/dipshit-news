---
headline: "President fires the Attorney General, requests an Army Chief retirement, and signs a 100% pharma tariff in one Thursday."
deck: "The day's headline was the firing. The day's policy was the tariff with the carve-outs that erased it."
date: 2026-04-02
author: vincent-crowe
score: 80
category: staffing
tags: ["bondi", "tariffs", "shake-ups"]
sourceUrl: "https://www.npr.org/2026/04/02/g-s1-115077/trump-bondi-attorney-general-departure"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "All three actions are documented; the carve-outs were public."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The 100% tariff was announced as if it were a 100% tariff."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The Attorney General's removal followed a leak investigation; no orderly handoff was visible."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The pharma tariff carve-outs were buried in the implementing text."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Three wire stories, each leading their respective verticals."
---
