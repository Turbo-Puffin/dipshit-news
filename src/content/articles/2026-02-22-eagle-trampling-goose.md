---
headline: "An armed man is shot at Mar-a-Lago; the White House posts a cartoon eagle trampling a Canadian goose."
deck: "Two stories on the same Sunday. The bird image was the one the press shop wanted in the rotation."
date: 2026-02-22
author: frank-dalton
score: 79
category: tweets
tags: ["mar-a-lago", "canada", "shooting"]
sourceUrl: "https://www.cnn.com/2026/02/22/politics/mar-a-lago-man-shot-armed"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The shooting and the post are both on the public record."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The press shop posted a goose-trampling image hours after the shooting at the President's home."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "The Mar-a-Lago shooting was being reported on the wire while the meme was being scheduled."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "The post stayed up. The President was at the White House."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Both stories ran. The Canadian foreign minister, asked about the bird, declined to comment."
---
