---
headline: "Administration takes the Fed governor firing to the Supreme Court; the next FOMC meeting is in three days."
deck: "After the appeals court declined to lift the order, the administration filed an emergency application at the Supreme Court."
date: 2025-09-20
author: vincent-crowe
score: 74
category: orders
tags: ["lisa-cook", "supreme-court", "emergency-application"]
sourceUrl: "https://www.aljazeera.com/economy/2025/9/18/trump-asks-supreme-court-to-let-him-fire-fed-governor-cook"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The application is on the docket. The FOMC meeting was scheduled."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The brief acknowledges the calendar is part of the case."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "Solicitor General signed. Filed under deadline."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "None offered. The legal theory has been twice rejected."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Front page of every business section by Sunday."
---
