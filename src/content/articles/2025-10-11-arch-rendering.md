---
headline: "President holds up a rendering of a 250-foot triumphal arch he would like built across the Potomac."
deck: "The arch, taller than the Lincoln Memorial, is topped with a gilded statue of Liberty. The country is in day eleven of a shutdown."
date: 2025-10-11
author: vincent-crowe
score: 76
category: orders
tags: ["triumphal-arch", "construction", "shutdown"]
sourceUrl: "https://www.britannica.com/topic/Washington-DC-Triumphal-Arch"
...
rubric:
  - label: "Factual basis"
    score: 14
    cap: 25
    note: "The renderings are public; Harrison Design submitted them to the CFA."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "Held up on day eleven of the shutdown."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "Multiple aides confirmed the project is moving forward."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The Commission of Fine Arts will be fired three weeks later."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Architecture press, mainstream coverage, late-night."
---
