---
headline: "On the fifth anniversary of the Capitol attack, the White House publishes a website saying it didn't happen."
deck: "The site says zero officers died. Brian Sicknick's family disagrees with the website."
date: 2026-01-06
author: carla-boone
score: 86
category: orders
tags: ["january-6", "capitol", "history-rewrite"]
sourceUrl: "https://www.washingtonpost.com/politics/2026/01/06/trump-white-house-jan6-website/"
...
rubric:
  - label: "Factual basis"
    score: 5
    cap: 25
    note: "The claim that 'zero law enforcement officers lost their lives' contradicts the public death record."
  - label: "Self-awareness"
    score: 3
    cap: 20
    note: "Published on the fifth anniversary, on whitehouse.gov."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The communications shop owned the launch."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The page stayed up."
  - label: "Public spectacle"
    score: 16
    cap: 20
    note: "Cross-network coverage; survivors of the attack on camera responding."
---
