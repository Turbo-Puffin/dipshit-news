---
headline: "Twenty thousand people in Copenhagen and five thousand in Nuuk hold the largest protests in Greenland's history."
deck: "The slogans were 'Hands off Greenland,' 'Yankee, Go Home,' and 'Make America Go Away.'"
date: 2026-01-17
author: vincent-crowe
score: 76
category: foreign
tags: ["greenland", "denmark", "protests"]
sourceUrl: "https://www.cnn.com/2026/01/17/europe/protesters-denmark-greenland-trump-intl"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The crowd numbers are estimates from the Danish and Greenlandic press."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The same evening's tariff post linked the demands to Greenland."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The Truth Social post named the eight countries by name."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The administration framed it as a negotiation tactic."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Above-the-fold coverage in twenty-three European languages."
---
