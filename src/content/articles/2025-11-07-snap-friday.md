---
headline: "Federal judge orders the administration to pay full SNAP benefits by end of day; the administration runs to the Supreme Court."
deck: "Forty-two million Americans use the program. The administration's plan was to pay sixty-five percent."
date: 2025-11-07
author: frank-dalton
score: 84
category: orders
tags: ["snap", "shutdown", "scotus"]
sourceUrl: "https://www.cnn.com/2025/11/06/politics/snap-november-payments"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 6
    cap: 25
    note: "Contingency funds existed. The judge said use them."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "Filed an emergency stay against feeding people."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "USDA sent a memo telling states to 'undo' efforts to disburse full benefits. A second judge blocked that memo."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "Asked SCOTUS for a stay. The Supreme Court granted a brief one. The optics were the optics."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Forty-two million Americans. Headlines on every front page that weekend."
---
