---
headline: "Three sitting members of Congress turned away from a federal building they have a statutory right to enter."
deck: "Federal agents with weapons drawn at the door. The reason offered: a seven-day notice rule a court had already blocked."
date: 2026-01-10
author: frank-dalton
score: 79
category: staffing
tags: ["congressional-oversight", "ice", "fort-snelling"]
sourceUrl: "https://www.startribune.com/rep-omar-craig-morrison-ice-detention-center-visit-minnesota-immigration-protest/601561763"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The visit, the denial, and the prior court order are all on the record."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "DHS cited a rule that had been temporarily blocked the previous month."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The DHS press shop owned the rationale. The agents at the door owned the weapons."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The denial held."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Wall-to-wall in Minneapolis. Wire copy by evening."
---
