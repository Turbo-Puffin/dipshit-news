---
headline: "The Vice President's Pakistan trip is on, then off, then back to the residence by suppertime."
deck: "Pakistan was waiting on a delegation it never received. The official explanation arrived at the gate."
date: 2026-04-22
author: frank-dalton
score: 70
category: staffing
tags: ["vance", "pakistan", "scheduling"]
sourceUrl: "https://www.axios.com/2026/04/21/iran-us-war-peace-talks-vance-pakistan"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The schedule changes are on the record; Pakistani statements are public."
  - label: "Self-awareness"
    score: 7
    cap: 20
    note: "The President's extension post pre-empted the Vice President's flight."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The Vice President's office did not preview the change of plans."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "The trip remained tentatively on the calendar; no specific date was set."
  - label: "Public spectacle"
    score: 8
    cap: 20
    note: "Inside-baseball foreign-policy beat; carried by the political press."
---
