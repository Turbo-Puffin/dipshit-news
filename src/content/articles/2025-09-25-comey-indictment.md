---
headline: "Former FBI director is indicted four days after the President posted that the DOJ should move 'now.'"
deck: "The interim US Attorney who recommended against charges was forced out. The replacement was the President's former personal lawyer."
date: 2025-09-25
author: frank-dalton
score: 87
category: orders
tags: ["comey", "indictment", "doj"]
sourceUrl: "https://abcnews.com/US/former-fbi-director-james-comey-indicted-days-after/story?id=125935658"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The indictment, the Truth Social post, and the personnel sequence are documented."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The Truth Social post named the target."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "Career prosecutors were reportedly not on the indicting team."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The President called it 'great news' on Truth Social."
  - label: "Public spectacle"
    score: 17
    cap: 20
    note: "Multiple Republican senators expressed concern publicly."
---
