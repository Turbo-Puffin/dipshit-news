---
headline: "Government shuts down at midnight; the President spends day one threatening to fire the people who weren't already furloughed."
deck: "The first federal shutdown in nearly seven years begins. The OMB freezes $18 billion in New York infrastructure projects before lunch."
date: 2025-10-01
author: frank-dalton
score: 82
category: economy
tags: ["shutdown", "omb", "vought"]
sourceUrl: "https://www.cbsnews.com/live-updates/government-shutdown-latest-shutdown-begins-trump/"
...
rubric:
  - label: "Factual basis"
    score: 12
    cap: 25
    note: "The shutdown is real. The OMB freeze is in writing."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The first move on day one was punitive, not restorative."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The OMB director ran the public messaging on shutdown day."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. Talks were not held."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Front page on every wire by 8 a.m."
---
