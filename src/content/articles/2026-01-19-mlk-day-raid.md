---
headline: "On Martin Luther King Jr. Day, ICE raids the home of a Hmong American grandfather and finds out, on scene, he is a citizen."
deck: "Mr. Thao was handcuffed in fourteen-degree weather in boxer shorts and Crocs. The agents confirmed his citizenship after the cuffs went on."
date: 2026-01-19
author: frank-dalton
score: 88
category: orders
tags: ["ice", "minneapolis", "mlk-day"]
sourceUrl: "https://www.mprnews.org/story/2026/01/19/ice-presence-affects-annual-powderhorn-park-mlk-day-celebration"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The names and the timeline are on the record. The conditions are documented by the family."
  - label: "Self-awareness"
    score: 3
    cap: 20
    note: "The proclamation for the day was about Martin Luther King Jr."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "DHS did not issue a same-day statement. ICE confirmed citizenship on scene."
  ...
  - label: "Public spectacle"
    score: 16
    cap: 20
    note: "Local press wall-to-wall. National coverage by Tuesday morning."
---
