---
headline: "Marine artillery demonstration over Interstate 5 prematurely detonates and rains shrapnel on the Vice President's motorcade route."
deck: "The state had asked them not to fire over the freeway. The Vice President was in town. They fired anyway."
date: 2025-10-18
author: carla-boone
score: 82
category: public
tags: ["camp-pendleton", "vance", "live-fire"]
sourceUrl: "https://www.cnn.com/2025/10/19/us/camp-pendleton-marines-demonstration-shell"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The CHP confirmed the strike. The Marine Corps confirmed the misfire."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The state had publicly objected to firing live ordnance over an interstate."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The Pentagon stuck to the planned demonstration despite the objection."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "Statement after the fact. No injuries reported."
