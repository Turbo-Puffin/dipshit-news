---
headline: "President says he renovated the Reflecting Pool for $1.9 million; the prior estimate was $350 million."
deck: "A casual stat from the podium that, if true, makes the General Services Administration look like it is operating a luxury car wash."
date: 2026-05-04
author: frank-dalton
score: 76
category: public
tags: ["receipts", "anecdotes", "podium-math"]
...
rubric:
  - label: "Factual basis"
    score: 8
    cap: 25
    note: "The figures may both be real. They cannot both be apples-to-apples."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "Told as a personal anecdote, twice."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "GSA was not asked to comment in advance."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "Repeated 'and I did it for less than two million.'"
  - label: "Public spectacle"
    score: 10
    cap: 20
    note: "At a small business summit. The crowd nodded."
---
