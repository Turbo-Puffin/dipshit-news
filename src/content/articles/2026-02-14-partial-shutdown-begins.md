---
headline: "A partial shutdown begins, this time for the Department of Homeland Security."
deck: "Negotiations failed. The agency that detains people for a living is now operating without funding."
date: 2026-02-14
author: vincent-crowe
score: 70
category: economy
tags: ["shutdown", "dhs", "valentines-day"]
sourceUrl: "https://www.cnn.com/politics/live-news/trump-state-of-the-union-2026"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The lapse is on the federal calendar. The negotiations are on the public record."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The principal had been on record demanding more aggressive enforcement, not less funding."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The President was traveling. The negotiations failed without him in the room."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "Counterproposals were exchanged the following Monday."
  - label: "Public spectacle"
    score: 10
    cap: 20
    note: "Carried on the political wires. Skipped on the lifestyle pages."
---
