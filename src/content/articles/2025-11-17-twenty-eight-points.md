---
headline: "American envoy and Russian envoy draft a Ukraine peace plan; Ukrainian envoy not on the line."
deck: "Twenty-eight points. Witkoff and Dmitriev. Kyiv received the document on the same day Moscow did."
date: 2025-11-17
author: vincent-crowe
score: 81
category: foreign
tags: ["ukraine", "peace-plan", "witkoff"]
sourceUrl: "https://www.chathamhouse.org/2025/11/trump-pressures-ukraine-accept-peace-deal"
...
rubric:
  - label: "Factual basis"
    score: 12
    cap: 25
    note: "The plan was reportedly drafted between Witkoff and Dmitriev with Ukrainian officials briefed afterward."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The Thanksgiving deadline was set on the same call as the briefing."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "European allies learned of the draft through leaks rather than through the State Department."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "Walked back from 'sign by Thanksgiving' to 'agree by Thanksgiving' over the weekend."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Headlines from Kyiv to Berlin. NATO foreign ministers met in emergency session."
---
