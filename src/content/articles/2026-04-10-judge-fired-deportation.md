---
headline: "Administration fires the Boston immigration judge who blocked the Tufts student's deportation."
deck: "Judge Roopal Patel ruled DHS had not met its burden. By April, she was fired. By that count, more than a hundred immigration judges have now been removed."
date: 2026-04-10
author: frank-dalton
score: 78
category: staffing
tags: ["immigration-courts", "purge", "ozturk"]
sourceUrl: "https://abcnews.com/US/administration-fires-2-immigration-judges-ruled-deporting-palestinian/story?id=131997768"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The firing is reported by multiple outlets; the count is the published EOIR figure."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "No public explanation was given for the dismissal."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "EOIR has not commented on the criteria used."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. Two more judges were fired the same week."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "Lead story in Boston, in the legal press, and on the immigration beat."
---
