---
headline: "Summit briefing materials are found on a public hotel printer; the press secretary calls it a lunch menu."
deck: "Eight pages from the State Department, including the meeting room sequence, staff phone numbers, and the planned gift to Putin. Discovered by guests at the Hotel Captain Cook."
date: 2025-08-16
author: frank-dalton
score: 89
category: staffing
tags: ["opsec", "hotel-printer", "lunch-menu"]
sourceUrl: "https://www.npr.org/2025/08/16/nx-s1-5504196/trump-putin-summit-documents-left-behind"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 4
    cap: 25
    note: "It was not a lunch menu. The first page is the room schedule."
  - label: "Self-awareness"
    score: 3
    cap: 20
    note: "The deputy press secretary said leaving documents on a public printer was 'hilarious.'"
  - label: "Staff containment"
    score: 5
    cap: 20
    note: "No one has been identified as responsible."
  - label: "Recovery attempt"
    score: 3
    cap: 15
    note: "The 'lunch menu' framing was repeated to multiple outlets."
  - label: "Public spectacle"
    score: 17
    cap: 20
    note: "Front-page everywhere by Sunday morning."
---
