---
headline: "President speaks at a stadium memorial that mixes prayer and political rally; the speakers' list includes the Vice President and Stephen Miller."
deck: "State Farm Stadium, Glendale, Arizona. Tens of thousands. Hymns, then takedowns. The hymns mostly came first."
date: 2025-09-21
author: carla-boone
score: 70
category: public
tags: ["charlie-kirk", "memorial", "state-farm-stadium"]
sourceUrl: "https://time.com/7319365/charlie-kirk-memorial-stephen-miller-trump-speech/"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "Speakers, sequence, and crowd estimate are documented."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The President added political asides to the eulogy."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The program was constructed as a public event."
  - label: "Recovery attempt"
    score: 7
    cap: 15
    note: "Family members spoke first. Erika Kirk delivered an actual eulogy."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Carried live across multiple cable networks for over four hours."
---
