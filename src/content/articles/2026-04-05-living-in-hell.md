---
headline: "President posts a profanity-laden threat hours after a U.S. colonel is rescued from Iran."
deck: "The post says Iran will be 'living in Hell' if the Strait of Hormuz is not open by Tuesday."
date: 2026-04-05
author: vincent-crowe
score: 81
category: foreign
tags: ["truth-social", "iran", "deadlines"]
sourceUrl: "https://www.npr.org/2026/04/05/nx-s1-5774368/iran-war-updates"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "The rescue is confirmed. The post is on the public record."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The post conflated the rescue with the deadline in one breath."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "No correction has been issued; the post remained up."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The deadline language was repeated in print the next day."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Front page of every wire by Sunday morning."
---
