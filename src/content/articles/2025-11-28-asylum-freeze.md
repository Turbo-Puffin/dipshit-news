---
headline: "Administration freezes all asylum decisions; the freeze covers everyone from everywhere."
deck: "One Afghan national shot two soldiers. The remedy is asylum from every country in the world, indefinitely."
date: 2025-11-28
author: frank-dalton
score: 79
category: orders
tags: ["asylum", "immigration", "national-guard"]
sourceUrl: "https://www.pbs.org/newshour/politics/trump-administration-halts-all-asylum-decisions-after-shooting-of-national-guard-members"
...
rubric:
  - label: "Factual basis"
    score: 7
    cap: 25
    note: "USCIS halted all asylum decisions globally; visa processing for Afghan passport holders also paused."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The freeze does not address the radicalization-after-arrival timeline that produced the actual incident."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "DHS and DOS coordinated; the order arrived as a single press release."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "By Sunday the President said the pause would last 'a long time.'"
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Hundreds of thousands of pending applications affected."
---
