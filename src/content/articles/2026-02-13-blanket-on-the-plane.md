---
headline: "DHS Secretary's Coast Guard pilot is fired over a missing blanket."
deck: "Then immediately rehired, because no other pilot was available to fly the return leg."
date: 2026-02-13
author: frank-dalton
score: 81
category: staffing
tags: ["noem", "coast-guard", "blanket"]
sourceUrl: "https://www.washingtontimes.com/news/2026/feb/13/kristi-noem-reportedly-coast-guard-pilot-fired-blanket-went-missing/"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "First reported by the Wall Street Journal. DHS confirmed the personnel decision in non-denial form."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The official statement said the agency makes personnel decisions to 'deliver excellence.'"
  - label: "Staff containment"
    score: 5
    cap: 20
    note: "The senior advisor reportedly entered the cockpit during ascent. That part is also on the record."
  - label: "Recovery attempt"
    score: 8
    cap: 15
    note: "The pilot was rehired the same day."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Front page of three papers Friday. Aviation press took it from there."
---
