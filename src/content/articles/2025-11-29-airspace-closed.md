---
headline: "President declares Venezuelan airspace 'closed.'"
deck: "Airspace is, in international law, a thing closed by the country whose airspace it is. The closing party here is not that country."
date: 2025-11-29
author: vincent-crowe
score: 78
category: foreign
tags: ["venezuela", "airspace", "war-powers"]
sourceUrl: "https://www.pbs.org/newshour/show/november-29-2025-pbs-news-weekend-full-episode"
...
rubric:
  - label: "Factual basis"
    score: 6
    cap: 25
    note: "International civil-aviation rules vest sovereign airspace authority in the underlying state."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "He posted the declaration on Truth Social on a Saturday."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "DOD and FAA spent the weekend interpreting the post; airlines reroute decisions were ad hoc."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "By Sunday the language migrated to 'we will be enforcing a closed airspace.'"
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Carriers including Iberia, Avianca, and Caribbean Airlines suspended Caracas service."
---
