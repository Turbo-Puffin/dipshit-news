---
headline: "President signs a memorandum directing the CDC to align the U.S. childhood vaccination schedule with peer countries; the agency removes coverage for six diseases."
deck: "The recommended list moves from seventeen diseases to eleven. The framing is 'best practices from peer, developed countries.'"
date: 2025-12-05
author: vincent-crowe
score: 78
category: health
tags: ["cdc", "childhood-vaccines", "memorandum"]
sourceUrl: "https://healthpolicy-watch.news/us-alters-childhood-vaccine-schedule-drops-six-common-vaccines/"
...
rubric:
  - label: "Factual basis"
    score: 6
    cap: 25
    note: "Peer-country comparisons in the memo do not match the WHO and ECDC published schedules."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The framing claims alignment with countries the memo misrepresents."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "CDC career staff dissented in writing."
  ...
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "Pediatricians' associations issued statements within hours."
---
