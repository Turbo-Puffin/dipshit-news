---
headline: "President posts 'CONGRATULATIONS to ABC' after the network suspends a late-night show; the FCC chair had threatened the network's affiliates."
deck: "ABC suspended Jimmy Kimmel Live. Five days later it would resume. The FCC chair's threat preceded the suspension by one day."
date: 2025-09-19
author: frank-dalton
score: 80
category: tweets
tags: ["kimmel", "fcc", "speech"]
sourceUrl: "https://www.npr.org/2025/09/24/nx-s1-5552132/examining-kimmels-brief-suspension-and-trumps-threats-to-free-speech"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The Carr remarks, the suspension, and the Truth Social post are all documented."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The post explicitly cheered a network for taking a regulator's threat seriously."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "Carr made the threat in a YouTube interview. The press shop did not pull it back."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "Carr later said his comments were 'misinterpreted.'"
  - label: "Public spectacle"
    score: 17
    cap: 20
    note: "Disney reversed by Monday. Sinclair and Nexstar still refused to air."
---
