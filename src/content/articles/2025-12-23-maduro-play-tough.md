---
headline: "President warns the Venezuelan leader not to 'play tough' as the U.S. tightens its naval blockade in the Caribbean."
deck: "The deadline the administration set for Maduro's departure passed on November 28 without his departure. Russia and China expressed support for the Venezuelan leader the same week."
date: 2025-12-23
author: vincent-crowe
score: 70
category: foreign
tags: ["venezuela", "maduro", "ultimatum"]
sourceUrl: "https://www.aljazeera.com/news/2025/12/23/trump-warns-maduro-not-to-play-tough-as-china-russia-back-venezuela"
...
rubric:
  - label: "Factual basis"
    score: 11
    cap: 25
    note: "The remarks, the deadline, and the Russian and Chinese statements are on the record."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The deadline was set by the administration; the deadline passed."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The State and Defense departments are operating to the President's framing."
  ...
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Front of every Caribbean and Latin American desk."
---
