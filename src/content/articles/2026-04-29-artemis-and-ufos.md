---
headline: "President hosts the Artemis II crew in the Oval Office and uses the time to talk about UFOs."
deck: "Four astronauts who flew around the Moon. The Oval availability ran on Comey, Iran, and the unidentified flying objects."
date: 2026-04-29
author: vincent-crowe
score: 71
category: public
tags: ["nasa", "artemis", "tangents"]
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The Oval Office event is on the public record; the press transcript is published."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The President talked over the astronauts on a question they were not asked."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "NASA's Administrator stood next to the astronauts and did not redirect."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The astronauts smiled politely."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Carried on every cable network; space press was particularly attentive."
---
