---
headline: "Treasury cancels every contract with Booz Allen Hamilton over a 2018 leak the contractor pleaded guilty to in 2023."
deck: "Thirty-one contracts, twenty-one million dollars. The triggering event predates the firm's current leadership."
date: 2026-01-26
author: vincent-crowe
score: 75
category: economy
tags: ["treasury", "booz-allen", "contracts"]
sourceUrl: "https://www.cnbc.com/2026/01/26/trump-tax-records-treasury-cancels-booz-allen-contracts.html"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The contracts, the cancellation, and the underlying leak are all documented."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The Secretary of Treasury cited an 'insider threat' that produced a five-year sentence."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The cancellation was issued under signature."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "Booz Allen issued a statement of surprise."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Trade press wall-to-wall. Stock fell eight percent."
---
