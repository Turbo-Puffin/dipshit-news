---
headline: "President Declares Ceasefire 'Life Support.' He Also Hadn't Finished Reading the Proposals."
deck: "Iran submitted a peace plan. The President called it unacceptable. He also mentioned he didn't finish reading it."
date: 2026-05-11
...
rubric:
  - label: "Factual basis"
    score: 23
    cap: 25
    note: "Trump publicly stated he did not finish reading Iran's peace proposals. The quote is documented."
  - label: "Self-awareness"
    score: 17
    cap: 20
    note: "Announced his own failure to read the proposals, apparently without registering that this was information."
  - label: "Staff containment"
    score: 15
    cap: 20
    note: "Nobody stopped him from saying it out loud. In public. During an active military conflict."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "Called the proposal 'totally unacceptable' as a pivot. The pivot did not help."
  - label: "Public spectacle"
    score: 18
    cap: 20
    note: "Active military standoff in the Strait of Hormuz. Oil prices rose. Global coverage."
---
