---
headline: "President names the Airbnb co-founder as the country's first Chief Design Officer."
deck: "An executive order calls for a 'national initiative to improve experiences for Americans,' starting with government websites."
date: 2025-08-21
author: carla-boone
score: 64
category: orders
tags: ["chief-design-officer", "airbnb", "vibes"]
sourceUrl: "https://thehill.com/policy/technology/5467734-trump-selects-airbnb-co-founder-as-first-government-design-head/"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The executive order exists. The appointment is real."
  - label: "Self-awareness"
    score: 9
    cap: 20
    note: "The order names a National Design Studio. With a capital D and S."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "The announcement was clean and on schedule."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "None needed. The position now exists."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "Modest. Appeared on the design and tech beats."
---
