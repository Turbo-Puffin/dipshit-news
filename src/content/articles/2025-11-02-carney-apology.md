---
headline: "Canadian prime minister apologizes for an ad that quoted Reagan accurately."
deck: "Reagan said tariffs lead to trade wars. Ontario put it in an ad. The President got an apology."
date: 2025-11-02
author: vincent-crowe
score: 73
category: foreign
tags: ["canada", "tariffs", "reagan"]
sourceUrl: "https://www.washingtonpost.com/world/2025/11/01/carney-trump-apologizes-canada-tariffs/"
sourcePublisher: "Washington Post"
readTime: "3 min read"
blurb: "The ad was accurate. The Prime Minister apologized anyway. That is the press release."
...
rubric:
  - label: "Factual basis"
    score: 9
    cap: 25
    note: "The Reagan quote in the ad was, on balance, fairly used per PBS fact-check."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "An apology was extracted from a head of government for citing the President's stated favorite Republican."
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "The 10% retaliatory tariff was already in place. The apology was extra."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None required, since no error had been admitted."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Carried in Canadian, American, and European outlets."
---
