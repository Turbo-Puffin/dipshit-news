---
headline: "President hosts a free spelling lesson in front of three networks."
deck: "A homophone explainer ran fourteen minutes long. Aides confirm there were no follow-up questions on policy."
date: 2026-05-06
author: carla-boone
score: 87
category: public
tags: ["unscripted", "homophones", "live-coverage"]
...
rubric:
  - label: "Factual basis"
    score: 21
    cap: 25
    note: "The two words do, in fact, sound alike."
  - label: "Self-awareness"
    score: 3
    cap: 20
    note: "Restated the lesson three separate times."
  - label: "Staff containment"
    score: 5
    cap: 20
    note: "Press secretary visibly bracing for the next sentence."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "Pivoted to 'the letter C, which is also a different one.'"
  - label: "Public spectacle"
    score: 18
    cap: 20
    note: "Three cable networks. One YouTube cut by lunch."
---
