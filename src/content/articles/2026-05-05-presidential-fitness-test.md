---
headline: "President signs proclamation reviving the Presidential Fitness Test for schoolchildren."
deck: "The administration brought back the sit-up regimen Obama replaced. Bryson DeChambeau and Gary Player attended."
date: 2026-05-05
author: vincent-crowe
score: 49
category: orders
tags: ["proclamations", "fitness-test", "schools"]
sourceUrl: "https://www.deseret.com/u-s-world/2026/05/05/president-donald-trump-signs-memorandum-youth-health-rfk-president-fitness-test-award-competition-bryson-dechambeau/"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The award is real. The fitness data the Secretary cited is largely real."
  - label: "Self-awareness"
    score: 7
    cap: 20
    note: "The President asked, on camera, what about me."
  - label: "Staff containment"
    score: 14
    cap: 20
    note: "RFK Jr., Hegseth, McMahon, and Turner kept the table on script."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "Not required. The proclamation reads cleanly."
  - label: "Public spectacle"
    score: 4
    cap: 20
    note: "A modest crowd. Three networks took the B-roll and moved on."
---
