---
headline: "United States bombs Caracas, captures the Venezuelan president, and posts a photo."
deck: "Operation Absolute Resolve hit at 2 a.m. local. By breakfast, the head of state was in a sweatsuit on a Navy ship."
date: 2026-01-03
author: carla-boone
score: 89
category: foreign
tags: ["venezuela", "maduro", "regime-change"]
sourceUrl: "https://www.npr.org/2026/01/03/g-s1-104329/explosions-caracas-venezuela"
sourcePublisher: "NPR"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The strike, the capture, and the photograph are all confirmed."
  - label: "Self-awareness"
    score: 3
    cap: 20
    note: "The Truth Social post, the sweatsuit detail, and 'we are going to run the country.'"
  - label: "Staff containment"
    score: 11
    cap: 20
    note: "The military side stayed clean. The communications side did the sweatsuit."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None. The photo was framed as the announcement."
  - label: "Public spectacle"
    score: 18
    cap: 20
    note: "Wall-to-wall on every cable network in the hemisphere."
---
