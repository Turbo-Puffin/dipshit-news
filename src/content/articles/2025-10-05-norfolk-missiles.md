---
headline: "Government remains closed; the Navy fires five $2 million missiles into the Atlantic for a 250th anniversary event."
deck: "The Sunday rally on the Norfolk pier featured ten thousand sailors, a 'YMCA' walk-off, and live ordnance."
date: 2025-10-05
author: vincent-crowe
score: 76
category: public
tags: ["navy-250", "norfolk", "missiles"]
sourceUrl: "https://www.pbs.org/newshour/politics/watch-live-trump-hegseth-celebrate-navys-250th-anniversary-at-naval-station-norfolk"
...
rubric:
  - label: "Factual basis"
    score: 14
    cap: 25
    note: "The event roster and ordnance use are documented in the press pool."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The shutdown was in day five and the air controllers were working unpaid."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The Defense Secretary and Navy Secretary were on stage."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The administration framed the event as a morale boost."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Aired live on multiple cable channels."
---
