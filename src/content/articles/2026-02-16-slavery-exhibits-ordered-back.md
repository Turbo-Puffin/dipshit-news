---
headline: "A federal judge orders the National Park Service to restore slavery-related exhibits at George Washington's Philadelphia home."
deck: "The exhibits were removed in January. The court ordered them back."
date: 2026-02-16
author: frank-dalton
score: 78
category: orders
tags: ["national-parks", "slavery", "court-order"]
sourceUrl: "https://www.usnews.com/news/politics/articles/2026-02-16/us-judge-tells-national-park-service-to-reinstall-philadelphia-slavery-exhibit"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The court order is on the docket. The removal was reported in January."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The original removal was procedural. The court was unimpressed."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The Park Service did not, on the public record, defend the removal at the hearing."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "The agency complied with the order without comment."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Picked up by the local Philadelphia papers and the history-museum trade press."
---
