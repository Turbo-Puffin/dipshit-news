---
headline: "CIA conducts a drone strike on a port facility on the Venezuelan coast; the strike is the first known U.S. attack on a target inside the country."
deck: "The strike, conducted earlier in December, was disclosed in the Tuesday news cycle. The Pentagon declined to comment. The administration did not announce a war powers notification."
date: 2025-12-30
author: carla-boone
score: 76
category: foreign
tags: ["cia", "venezuela", "port-strike"]
sourceUrl: "https://www.cnn.com/2025/12/30/us/5-things-to-know-for-dec-30-cia-drone-strike-store-closings-trump-netanyahu-meeting-kennedy-center-george-clooney"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 13
    cap: 25
    note: "The reporting is sourced and the Pentagon's no-comment is on record."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "Crossing the territorial threshold without notification is the part."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The disclosure came by reporting, not by White House announcement."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The administration declined to characterize the legal basis."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "Top of every defense and foreign-affairs desk."
---
