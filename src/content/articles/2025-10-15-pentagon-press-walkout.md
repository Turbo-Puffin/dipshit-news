---
headline: "Every major news outlet at the Pentagon turns in their badges rather than sign the new press rules."
deck: "The rules required reporters to acknowledge a sign-off they were not required to agree with. Only one outlet signed."
date: 2025-10-15
author: carla-boone
score: 78
category: orders
tags: ["pentagon", "press-rules", "hegseth"]
sourceUrl: "https://www.washingtonpost.com/business/2025/10/19/pentagon-press-policy-controversy/"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The signed letter and the badge return are both on the public record."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The President said in public that he didn't like reporters being on the building."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The Defense Secretary owned the policy."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The policy stood."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Cross-outlet coverage; rare wall-to-wall press story."
---
