---
headline: "On the NORAD Santa-tracker call from Mar-a-Lago the President tells an eight-year-old in Kansas that if Santa brings her coal, it will be 'clean, beautiful coal.'"
deck: "The girl had said she hoped Santa would not bring her coal. The President responded as quoted. The First Lady was on the line."
date: 2025-12-24
author: carla-boone
score: 60
category: public
tags: ["norad", "santa-tracker", "christmas-eve"]
sourceUrl: "https://www.washingtonpost.com/style/power/2025/12/25/trump-christmas-mar-a-lago-norad/"
...
rubric:
  - label: "Factual basis"
    score: 12
    cap: 25
    note: "The call is on the NORAD recording. The exchange is on the transcript."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The line is a coal-policy line, repurposed for a child."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The NORAD ops center had the script; the President improvised."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The First Lady, on the same call, told the child to be good."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "Top-of-page on style desks Christmas morning."
---
