---
headline: "President signs executive order against flag burning; the Supreme Court has ruled twice that flag burning is protected speech."
deck: "Texas v. Johnson, 1989. United States v. Eichman, 1990. Both 5–4. Both held that the First Amendment protects the act."
date: 2025-08-28
author: frank-dalton
score: 76
category: orders
tags: ["flag-burning", "first-amendment", "supreme-court"]
sourceUrl: "https://www.cbsnews.com/news/trump-flag-burning-cashless-bail-executive-orders/"
...
rubric:
  - label: "Factual basis"
    score: 7
    cap: 25
    note: "The Supreme Court has settled this twice. The order will not survive review."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The Justice Department conceded the constitutional issue at signing."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The order is narrowly drafted to direct AG enforcement priorities."
  - label: "Recovery attempt"
    score: 6
    cap: 15
    note: "The narrow drafting is itself a recovery attempt."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "Signed in front of a flag, on camera."
---
