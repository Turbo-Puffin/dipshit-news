---
headline: "Canadian Prime Minister flies to Washington for trade talks; leaves with no deal and no press conference."
deck: "Two heads of state, two flags, two hours of cameras. The trade minister came out alone to say talks are 'ongoing.'"
date: 2025-10-07
author: frank-dalton
score: 67
category: foreign
tags: ["canada", "carney", "tariffs"]
sourceUrl: "https://www.cbc.ca/news/politics/trump-carney-meeting-white-house-1.7652510"
...
rubric:
  - label: "Factual basis"
    score: 13
    cap: 25
    note: "The bilat happened. The trade minister handled the post-meeting alone."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The President said 'Canada will love us again' on camera."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The Canadian side limited their post-meeting exposure."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "Both sides described talks as 'substantive.' No specifics."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "Lead foreign-policy story on Canadian wires."
---
