---
headline: "Press secretary confirms the Defense Secretary authorized a follow-up strike on apparent survivors clinging to the wreckage of an alleged drug boat in the Caribbean."
deck: "The original September strike was already on the record. The follow-up was the part the administration had not previously confirmed."
date: 2025-12-04
author: frank-dalton
score: 84
category: foreign
...
rubric:
  - label: "Factual basis"
    score: 8
    cap: 25
    note: "The reporting is sourced; the spokeswoman confirmed it from the podium."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The administration framed the survivors as combatants."
  - label: "Staff containment"
    score: 5
    cap: 20
    note: "The press secretary confirmed it after the leak forced confirmation."
  ...
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Front of every defense section in Washington."
---
