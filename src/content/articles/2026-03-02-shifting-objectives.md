---
headline: "The administration's stated objectives for the Iran war keep changing as the bombs fall."
deck: "On day three of Operation Epic Fury, the goals on the record do not match the goals from the previous day."
date: 2026-03-02
author: vincent-crowe
score: 72
category: foreign
tags: ["iran-war", "objectives", "epic-fury"]
sourceUrl: "https://www.cnn.com/2026/03/03/politics/trump-iran-war-explanations-goals"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "The contradictions are on the public record across multiple outlets."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "Each new statement is delivered with the certainty of the previous one."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The Press Secretary issued a list of four objectives on March 4. The President had already named more."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The earlier statements remain on the record."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "CNN's review of the contradictions ran on the day in question."
---
