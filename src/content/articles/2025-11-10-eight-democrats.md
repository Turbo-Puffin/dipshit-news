---
headline: "Senate advances the shutdown deal sixty to forty; eight Democrats break from leadership."
deck: "The deal does not extend the ACA subsidies. The ACA subsidies were the fight."
date: 2025-11-10
author: frank-dalton
score: 73
category: economy
tags: ["shutdown", "senate", "aca"]
sourceUrl: "https://www.cnbc.com/2025/11/09/government-shutdown-senate-democrats.html"
...
rubric:
  - label: "Factual basis"
    score: 9
    cap: 25
    note: "The deal does not extend the subsidies. The promised vote is in mid-December."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The fight that closed the government for 43 days was traded for a promise."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "Schumer voted no. Eight of his caucus voted yes anyway."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "Talking-point memos called the deal a 'win on layoffs.' The layoffs are still being undone in court."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Sunday-night Senate vote, livestreamed; flight cancellations were the backdrop."
---
