---
headline: "President posts that Roger Clemens belongs in the Baseball Hall of Fame, NOW."
deck: "From the golf course on a Sunday, the President weighs in on a Cooperstown vote that the President does not get to cast."
date: 2025-08-24
author: carla-boone
score: 52
category: tweets
tags: ["truth-social", "baseball", "cooperstown"]
sourceUrl: "https://www.cnn.com/2025/08/25/sport/golf-ryder-cup-trump-intl"
sourcePublisher: "CNN"
readTime: "2 min read"
...
rubric:
  - label: "Factual basis"
    score: 14
    cap: 25
    note: "The President does not have a vote in Hall of Fame elections."
  - label: "Self-awareness"
    score: 8
    cap: 20
    note: "Posted from the golf course alongside a photo with Clemens."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The post was personal. The press shop did not amplify."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None needed. None offered."
  - label: "Public spectacle"
    score: 7
    cap: 20
    note: "Sports desks. Page two."
---
