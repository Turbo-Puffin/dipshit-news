---
headline: "An executive order bars 'racially discriminatory DEI activities' by every federal contractor."
deck: "The order does not define the term. It permits termination of any contract on the contracting officer's reading."
date: 2026-03-26
author: vincent-crowe
score: 72
category: orders
tags: ["dei", "executive-order", "contractors"]
sourceUrl: "https://www.whitehouse.gov/presidential-actions/2026/03/addressing-dei-discrimination-by-federal-contractors/"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "The order is on the Federal Register. The implementation date is April 24."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The order does not define the term whose activity it prohibits."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The OMB has been instructed to issue further guidance."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The order grants the contracting officer wide latitude."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "On the lead of every law-firm client alert by Friday morning."
---
