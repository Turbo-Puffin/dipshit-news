---
headline: "Federal appeals court lets the President keep building the ballroom for one more week."
deck: "A 2-1 ruling. The argument that won was that there is, indeed, a bunker."
date: 2026-04-11
author: vincent-crowe
score: 73
category: orders
tags: ["ballroom", "appeals-court", "national-security"]
sourceUrl: "https://www.cnn.com/2026/04/11/politics/trump-ballroom-construction-judge-continue"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The 2-1 order is on the public docket; the prior District Court ruling is also public."
  - label: "Self-awareness"
    score: 7
    cap: 20
    note: "The administration pleaded national security on a ballroom."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "Counsel filed within the appellate window; the dissent objected."
  - label: "Recovery attempt"
    score: 7
    cap: 15
    note: "The appeals court's grant was narrow and time-limited."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Cable carried the ruling; the building site was photographed continuously."
---
