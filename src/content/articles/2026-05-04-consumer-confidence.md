...
score: 73
category: economy
tags: ["sentiment", "fact-check", "metrics"]
sourceUrl: "https://www.wral.com/news/state/fact-check-donald-trump-consumer-confidence-may-8/"
...
rubric:
  - label: "Factual basis"
    score: 4
    cap: 25
    note: "All three published indices say the opposite."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "Said it like it was on the prompter."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "No correction has been issued."
  ...
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "On camera. Picked up by every wire."
---
