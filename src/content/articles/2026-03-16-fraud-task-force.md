---
headline: "The President signs an executive order creating a federal Task Force to Eliminate Fraud."
deck: "It will be chaired by the Vice President. It will exclude examination of contractor relationships involving the President's family."
date: 2026-03-16
author: frank-dalton
score: 67
category: orders
tags: ["fraud", "task-force", "vance"]
sourceUrl: "https://ballotpedia.org/Executive_Order:_Establishing_the_Task_Force_to_Eliminate_Fraud_(Donald_Trump,_2026)"
...
rubric:
  - label: "Factual basis"
    score: 16
    cap: 25
    note: "The executive order is on the Federal Register. The composition of the Task Force is in the order's text."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The order's stated mission is the elimination of fraud. The order does not address self-dealing in federal contracting."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "The signing ceremony was held in the Eisenhower Executive Office Building."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "The administration framed the order as a populist priority."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Standard executive-order coverage. Buried under the Iran war."
---
