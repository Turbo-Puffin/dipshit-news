---
headline: "After a federal judge orders it, the administration releases the rest of the Gateway tunnel money."
deck: "The President called the project a 'future boondoggle.' The judge said the freeze was unlawful."
date: 2026-02-18
author: carla-boone
score: 67
category: orders
tags: ["gateway", "infrastructure", "court-order"]
sourceUrl: "https://www.cnbc.com/2026/02/18/gateway-trump-funding-new-york-jersey-tunnel-hochul.html"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The funds were released in tranches per the court's timetable."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The President had described the project, on the record, as a 'future boondoggle.'"
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "DOT issued a brief statement and complied with the order."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The Governor said the delay had cost the project more money."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "Carried in the regional press. Skipped on national broadcast."
---
