---
headline: "President signs an executive order directing federal agencies to challenge state laws regulating artificial intelligence."
deck: "The order establishes a Justice Department AI Litigation Task Force. The states are, in this story, the defendants."
date: 2025-12-11
author: vincent-crowe
score: 70
category: orders
tags: ["ai-policy", "preemption", "executive-order"]
sourceUrl: "https://www.sidley.com/en/insights/newsupdates/2025/12/unpacking-the-december-11-2025-executive-order"
sourcePublisher: "Sidley Austin"
readTime: "3 min read"
blurb: "The order opens a federal litigation front against state AI laws. The DOJ has a new task force for the purpose."
rubric:
  - label: "Factual basis"
    score: 11
    cap: 25
    note: "The order is published. The legal community has begun analysis."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The order is silent on the federal AI law that does not exist."
  - label: "Staff containment"
    score: 10
    cap: 20
    note: "The agencies will brief the litigation as directed."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The fact sheet anchors the order in 'minimal regulatory burden.'"
  - label: "Public spectacle"
    score: 8
    cap: 20
    note: "Front of the technology and federalism beats."
---
