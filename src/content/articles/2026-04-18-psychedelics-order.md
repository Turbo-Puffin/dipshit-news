---
headline: "President signs an executive order accelerating FDA review of psychedelic drugs for serious mental illness."
deck: "Ibogaine, psilocybin, methylone. By April 24, the FDA had issued three priority vouchers."
date: 2026-04-18
author: carla-boone
score: 67
category: orders
tags: ["psychedelics", "fda", "executive-orders"]
sourceUrl: "https://www.cnn.com/2026/04/18/politics/trump-signs-executive-order-urging-more-research-into-psychedelic-ibogaine"
sourcePublisher: "CNN"
readTime: "2 min read"
blurb: "An executive order to fast-track FDA review of psychedelics. Six days later, three priority vouchers were already out the door."
featured: false
rubric:
  - label: "Factual basis"
    score: 22
    cap: 25
    note: "The order is in the Federal Register; the FDA implementation followed."
  - label: "Self-awareness"
    score: 11
    cap: 20
    note: "Cited Stanford's veterans-with-TBI ibogaine study by name."
  - label: "Staff containment"
    score: 13
    cap: 20
    note: "The Commissioner had vouchers ready within a week."
  - label: "Recovery attempt"
    score: 9
    cap: 15
    note: "Not needed; the order was, on its merits, popular with veterans groups."
  - label: "Public spectacle"
    score: 7
    cap: 20
    note: "Sober coverage; this one did not produce a meme."
---
