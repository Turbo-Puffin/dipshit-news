---
headline: "Treasury sanctions a Colombian president, a Brazilian justice, and a UN human rights official."
deck: "The administration's grounds in each case were criticism of the United States. The statute requires more than that."
date: 2026-03-17
author: vincent-crowe
score: 75
category: foreign
tags: ["sanctions", "petro", "albanese"]
sourceUrl: "https://www.npr.org/2026/03/17/nx-s1-5675211/treasury-sanctions-trump-foreign-punish"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "Treasury issued the designations on the public OFAC list. NPR documented the pattern."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The sanctions framework is intended to apply to terrorism, narcotics, and human-rights abuses."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "Treasury has not issued public legal justifications beyond pro-forma statements."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "Albanese's family filed suit on February 26 to challenge the sanction."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "Spread across the diplomatic press in the United States, Brazil, Colombia, and Italy."
---
