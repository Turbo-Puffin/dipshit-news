---
headline: "President posts a fist-bump photo with the disgraced NFL coach; the internet notices the outfit is from a week ago."
deck: "On Sunday the President wrote 'NEVER FELT BETTER IN MY LIFE' and posted a golf photo with Jon Gruden. The shirt matches a photo from August 23."
date: 2025-08-31
author: frank-dalton
score: 71
category: tweets
tags: ["jon-gruden", "fist-bump", "outfit-detective"]
...
rubric:
  - label: "Factual basis"
    score: 11
    cap: 25
    note: "The shirt does match a Gruden Instagram post dated August 23."
  - label: "Self-awareness"
    score: 7
    cap: 20
    note: "Posted to address health rumors with a photo that may have been recycled."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The post was personal. The press shop did not vet."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "No follow-up from the President. No date confirmed."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Lit up sports Twitter. Jumped to mainstream coverage by Monday."
---
