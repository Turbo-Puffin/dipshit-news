---
headline: "The President says Iran's next supreme leader will need approval from him."
deck: "He told ABC News: 'If he doesn't get approval from us, he's not going to last long.'"
date: 2026-03-03
author: carla-boone
score: 78
category: foreign
tags: ["iran-war", "khamenei", "succession"]
sourceUrl: "https://abcnews.com/Politics/irans-supreme-leader-long-approval-trump/story?id=130878307"
...
rubric:
  - label: "Factual basis"
    score: 21
    cap: 25
    note: "ABC News has the quote on tape and on the transcript."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "Said in the same interview that the U.S. does not seek regime change."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "The Press Secretary did not walk it back. The State Department had no comment."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. Iran appointed Mojtaba Khamenei the next week without consulting Washington."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Carried on every wire."
---
