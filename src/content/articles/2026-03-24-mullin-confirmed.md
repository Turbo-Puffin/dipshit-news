---
headline: "The Senate confirms Markwayne Mullin as DHS Secretary, 54 to 45."
deck: "He will take the oath next Tuesday. He will inherit the longest agency shutdown in American history."
date: 2026-03-24
author: carla-boone
score: 68
category: staffing
tags: ["mullin", "confirmation", "dhs"]
sourceUrl: "https://abcnews.com/Politics/trump-privately-expresses-frustration-noem-after-senate-hearing/story?id=130794961"
sourcePublisher: "ABC News"
readTime: "3 min read"
blurb: "Three Republicans voted against. The new Secretary takes over an agency where most workers have not been paid in five weeks."
featured: false
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "The vote is on the Senate roll. The party breakdown is published."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The new Secretary will inherit a department whose workforce has not been paid in five weeks."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The transition is on the official schedule for March 31."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The new Secretary has committed to scrap his predecessor's signature FEMA policy."
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "On the lead of the politics section in major wires."
---
