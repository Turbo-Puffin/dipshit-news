---
headline: "President toasts the Princess of Wales as 'so radiant, so healthy, so beautiful' at the state banquet."
deck: "British protocol experts noted that personal commentary on a royal woman's appearance is, by tradition, not the form. The toast itself ended with a thanks to a 'very, very special Queen.'"
date: 2025-09-17
author: vincent-crowe
score: 64
category: foreign
tags: ["state-banquet", "windsor", "toast"]
sourceUrl: "https://rollcall.com/factbase/trump/transcript/donald-trump-remarks-state-banquet-windsor-castle-united-kingdom-september-17-2025/"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The transcript is on file at Factba.se."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The protocol point was made by every UK paper by Thursday."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The remarks were prepared. Several lines were extemporaneous."
  ...
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Carried live across BBC, ITV, and Sky."
---
