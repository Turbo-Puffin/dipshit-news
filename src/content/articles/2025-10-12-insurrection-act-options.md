---
headline: "Vice President says the President is 'looking at all his options' on the Insurrection Act."
deck: "Asked plainly on Sunday morning whether the administration is considering invoking the Act, the Vice President did not say no."
date: 2025-10-12
author: carla-boone
score: 75
category: presser
tags: ["insurrection-act", "vance", "sunday-shows"]
sourceUrl: "https://www.newsweek.com/trump-is-looking-at-all-options-before-invoking-insurrection-act-vance-10866571"
sourcePublisher: "Newsweek"
readTime: "2 min read"
blurb: "Asked Sunday morning if the administration is considering the Insurrection Act, the VP did not say no. Hon."
...
rubric:
  - label: "Factual basis"
    score: 9
    cap: 25
    note: "The exchange is on tape and in transcripts."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "The day after the Seventh Circuit ruled against the administration."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "The Vice President stuck to the script. The script left the door open."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "Pivoted to 'he hasn't felt he needed to.'"
  - label: "Public spectacle"
    score: 11
    cap: 20
    note: "Lead segment on three Sunday shows."
---
