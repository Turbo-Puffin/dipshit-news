---
headline: "Third Circuit upholds the lower-court ruling that the President's former personal lawyer is unlawfully serving as the U.S. Attorney for New Jersey."
deck: "A 32-page decision from a three-judge panel. The first appeals-court loss in this category. The maneuver was the maneuver."
date: 2025-12-01
author: frank-dalton
score: 74
category: staffing
tags: ["habba", "us-attorney", "third-circuit"]
sourceUrl: "https://www.cnn.com/2025/12/01/politics/alina-habba-new-jersey-3rd-circuit"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 7
    cap: 25
    note: "The Federal Vacancies Reform Act says what it says."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "The administration walked through every other door before this one."
  - label: "Staff containment"
    score: 6
    cap: 20
    note: "DOJ argued the maneuver in court and lost it again."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "The next move is to nominate someone the Senate will confirm."
  - label: "Public spectacle"
    score: 9
    cap: 20
    note: "Front of every legal section Tuesday morning."
---
