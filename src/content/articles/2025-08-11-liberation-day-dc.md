---
headline: "President declares Liberation Day in the capital; the city's violent crime is at a thirty-year low."
deck: "An invocation of Section 740 of the Home Rule Act, federalizing the police, justified with statistics that point the other direction."
date: 2025-08-11
author: vincent-crowe
score: 84
category: public
tags: ["dc", "national-guard", "crime-statistics"]
sourceUrl: "https://www.washingtonpost.com/politics/2025/08/11/trump-national-guard-dc-crime-crackdown/"
...
rubric:
  - label: "Factual basis"
    score: 5
    cap: 25
    note: "DC violent crime is down 26% year-to-date and at a 30-year low."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "Used the phrase 'roving mobs of wild youth' from a podium."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "Bondi and Hegseth both spoke to defend the action."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. The mayor publicly cited the actual numbers."
  - label: "Public spectacle"
    score: 17
    cap: 20
    note: "Carried live on every cable network."
---
