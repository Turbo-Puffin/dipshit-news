---
headline: "The President fires the DHS Secretary on social media and names a senator to replace her."
deck: "She gets a new job called Special Envoy for the Shield of the Americas. He gets DHS, effective March 31."
date: 2026-03-05
author: vincent-crowe
score: 74
category: staffing
tags: ["dhs", "noem", "mullin"]
sourceUrl: "https://www.cnn.com/2026/03/05/politics/kristi-noem-trump-homeland-security-replace"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 19
    cap: 25
    note: "The President's announcement is on Truth Social. The reassignment is on the DHS website."
  - label: "Self-awareness"
    score: 6
    cap: 20
    note: "DHS issued a statement that thanked Secretary Noem for keeping America safe."
  - label: "Staff containment"
    score: 7
    cap: 20
    note: "The replacement was pre-staged. The new title for the outgoing Secretary was already drafted."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The administration framed it as a promotion to a hemispheric role."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "The first Cabinet departure of the second term, on the lead of every wire."
---
