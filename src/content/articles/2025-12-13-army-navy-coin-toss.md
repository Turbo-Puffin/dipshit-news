---
headline: "President flips the coin for the 126th Army-Navy game and the coin does not flip."
deck: "Mid-field at M&T Bank Stadium in Baltimore. The coin went up, did not rotate, and came down. Army won the toss."
date: 2025-12-13
author: frank-dalton
score: 76
category: public
tags: ["army-navy", "coin-toss", "126th-game"]
sourceUrl: "https://www.thedailybeast.com/donald-trump79-stuns-with-inability-to-flip-a-coin-worst-in-history/"
...
rubric:
  - label: "Factual basis"
    score: 13
    cap: 25
    note: "The coin toss is on tape from twelve angles."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The President pointed at the coin on the ground."
  - label: "Staff containment"
    score: 10
    cap: 20
    note: "The protocol staff handed him the coin and stepped back."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "The ref picked the coin up and called it tails."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Top trending video of the weekend across every sports network."
---
