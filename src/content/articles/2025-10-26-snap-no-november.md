---
headline: "USDA announces no SNAP benefits will be paid in November because of the shutdown; the contingency fund Congress set up for this purpose remains untouched."
deck: "The fund is on the books. The administration's position is that they cannot draw on it. Twenty-two states will sue inside forty-eight hours."
date: 2025-10-26
author: vincent-crowe
score: 84
category: economy
tags: ["snap", "shutdown", "contingency-fund"]
sourceUrl: "https://www.npr.org/2025/10/27/nx-s1-5587255/snap-benefit-shutdown-contingency-fund-food-stamps"
sourcePublisher: "NPR"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 17
    cap: 25
    note: "The contingency fund and its purpose are documented in appropriations text."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The contingency fund exists by name precisely for this scenario."
  - label: "Staff containment"
    score: 9
    cap: 20
    note: "USDA leadership owned the announcement."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "The administration was willing to litigate. The administration lost."
  - label: "Public spectacle"
    score: 14
    cap: 20
    note: "Front page in every state with a SNAP roll."
---
