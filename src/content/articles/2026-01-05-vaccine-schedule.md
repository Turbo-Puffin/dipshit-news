---
headline: "HHS removes flu, COVID, and hepatitis B from the recommended childhood vaccine schedule."
deck: "Eighteen diseases down to eleven. The acting CDC director signed a memo. The pediatricians' association did not."
date: 2026-01-05
author: vincent-crowe
score: 84
category: health
tags: ["vaccines", "cdc", "rfk-jr"]
sourceUrl: "https://www.cnn.com/2026/01/05/health/childhood-vaccine-schedule-overhaul"
sourcePublisher: "CNN"
readTime: "3 min read"
...
rubric:
  - label: "Factual basis"
    score: 14
    cap: 25
    note: "The schedule change is documented. The reasoning is contested by every relevant medical body."
  - label: "Self-awareness"
    score: 4
    cap: 20
    note: "Framed as 'aligning with international consensus.' It does not align."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "An acting CDC director signed. The career staff did not co-sign."
  - label: "Recovery attempt"
    score: 5
    cap: 15
    note: "None offered. The memo stood."
  - label: "Public spectacle"
    score: 13
    cap: 20
    note: "Wall-to-wall coverage in pediatric and public-health press."
---
