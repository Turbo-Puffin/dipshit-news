---
headline: "President asks for $1.15 trillion in base defense as a U.S. fighter jet goes down over Iran."
deck: "First confirmed downed American jet of the war. First trillion-dollar defense ask of the budget cycle."
date: 2026-04-03
author: carla-boone
score: 76
category: economy
tags: ["pentagon", "iran", "budget"]
sourceUrl: "https://www.cnbc.com/2026/04/03/trump-iran-threats-un-resolution-blocked-strait-of-hormuz-f35-shot-down.html"
...
rubric:
  - label: "Factual basis"
    score: 18
    cap: 25
    note: "The downed jet is confirmed. The budget number is the official ask."
  - label: "Self-awareness"
    score: 5
    cap: 20
    note: "The President's framing was that the regime knows what has to be done."
  - label: "Staff containment"
    score: 8
    cap: 20
    note: "The Pentagon released a statement; the White House did not retract the threat."
  - label: "Recovery attempt"
    score: 4
    cap: 15
    note: "None offered. A second strike on the Karaj bridge happened the same day."
  - label: "Public spectacle"
    score: 12
    cap: 20
    note: "Front page of every wire."
---
